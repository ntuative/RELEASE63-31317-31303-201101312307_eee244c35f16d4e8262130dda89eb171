package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1291:int = 128;
      
      private var var_1290:Boolean = false;
      
      private var var_2739:Point;
      ...
      {
         if(param1 != this.var_1611 || param2 != this.var_1610)
         {
      ...
      {
         if(this.var_1291 > 255 || bitmapData == null)
         {
            return false;
         }
