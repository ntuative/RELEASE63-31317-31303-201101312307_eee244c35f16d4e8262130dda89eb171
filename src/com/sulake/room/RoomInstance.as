   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_233 != null)
         {
            ...
            {
               _loc3_ = this.var_233.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_553)
            {
               delete this.var_553[_loc1_];
            }
            this.var_553 = null;
         }
         if(this.var_552 != null)
         {
            for(_loc1_ in this.var_552)
            {
               delete this.var_552[_loc1_];
            }
            this.var_552 = null;
         }
         this.var_1283 = [];
      ...
      {
         if(this.var_1284.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1283.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_552[param1] != param2)
         {
            this.var_552[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_533.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_533[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_144 != null)
            {
               this.var_144.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_144)
               {
                  this.var_144.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_144)
                  {
                     this.var_144.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_144.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_233.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_233.getValue(_loc2_) != null)
         {
            return this.var_233.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_233.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_233.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_233.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_233.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
