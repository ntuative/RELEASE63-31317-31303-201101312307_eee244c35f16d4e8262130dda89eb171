package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_667:Number = 64;
      
      public static const const_969:Number = 32;
      ...
      private var var_2749:Number = -500.0;
      
      private var var_2748:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1720 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_162.x,this.var_162.y,this.var_162.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_73.x * this.var_406,this.var_73.y * this.var_405,this.var_73.z * this.var_407);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_73.x /= this.var_406;
         this.var_73.y /= this.var_405;
         this.var_73.z /= this.var_407;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_161.assign(_loc24_);
            this.var_162.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_161.assign(_loc19_);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_490 != null)
         {
            ...
            return this.var_490.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1109.assign(_loc22_);
         }
         else
         {
            this.var_1109.assign(_loc17_);
         }
         ++this.var_151;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_161);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_406;
         _loc2_.y *= this.var_405;
         _loc2_.z *= this.var_407;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1109);
         if(_loc3_ < this.var_2749 || _loc3_ > this.var_2748)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_161);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_405;
            _loc2_.z *= this.var_407;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1109);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_161,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_73.x * this.var_406,this.var_73.y * this.var_405,this.var_73.z * this.var_407);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_162;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_406,param2.y * this.var_405,param2.z * this.var_407);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_406,param3.y * this.var_405,param3.z * this.var_407);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_406,param4.y * this.var_405,param4.z * this.var_407);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_667;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_667;
      }
