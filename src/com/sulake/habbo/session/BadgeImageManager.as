package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1112:String = "group_badge";
      
      public static const const_1564:String = "normal_badge";
       
      
      private const const_1663:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1663 + param1;
         ...
         switch(param2)
         {
            case const_1564:
               ...
               {
                  _loc5_ = this.var_176.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1112:
               if(this.var_176 != null)
               {
                  if(this.var_176 != null)
                  {
                     _loc5_ = this.var_176.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1663,"");
