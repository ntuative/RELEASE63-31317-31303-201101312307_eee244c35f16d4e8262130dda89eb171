package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_932:uint = 11;
      ...
      private var var_59:IRoomWidgetFactory;
      ...
      private var var_178:IHabboHelp;
      ...
      private var var_607:FramerateTracker = null;
      
      private var var_253:LatencyTracker = null;
      
      private var var_606:LagWarningLogger = null;
      
      private var var_608:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_607 = new FramerateTracker();
         this.var_253 = new LatencyTracker();
         this.var_606 = new LagWarningLogger();
         this.var_608 = new ToolbarClickTracker(this);
         this.var_1397 = new Array(const_932);
         var _loc4_:int = 0;
         while(_loc4_ < const_932)
         {
            this.var_1397[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1513,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1399,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_851,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_59)
            {
               this.var_59.release(new IIDHabboRoomWidget());
               this.var_59 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_192)
            {
               if(!this.var_192.disposed)
               {
                  ...
                  Component(this.var_192).events.removeEventListener(HabboFriendListTrackingEvent.const_392,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_178)
            {
               if(!this.var_178.disposed)
               {
                  this.var_178.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_178.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_178.release(new IIDHabboHelp());
               this.var_178 = null;
            }
            if(this.var_165)
            {
      ...
      {
         this.var_1397[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_176 = IHabboConfigurationManager(param2);
         if(this.var_176)
         {
            if(this.var_253 != null)
            {
               this.var_253.configuration = this.var_176;
            }
            if(this.var_254 != null)
            {
               this.var_254.configuration = this.var_176;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1367);
            if(this.var_176)
            {
               if(this.var_606 != null)
               {
                  this.var_606.configure(this.var_176);
               }
               if(this.var_607 != null)
               {
                  this.var_607.configure(this.var_176);
               }
               if(this.var_608 != null)
               {
                  this.var_608.configure(this.var_176);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_156);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_865,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_70,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_497,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_253 != null)
            {
               this.var_253.communication = this._communication;
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_865)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1606);
         }
         else if(param1.type == HabboHotelViewEvent.const_497)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1575);
         }
         else if(param1.type == HabboHotelViewEvent.const_70)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1536);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1372);
               break;
            case HabboCommunicationEvent.const_693:
               this.trackLoginStep(HabboLoginTrackingStep.const_1603,String(this._communication.port));
               break;
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_176)
            {
               if(this.var_176.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_176.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1397)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1145);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1145,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_192).events.addEventListener(HabboFriendListTrackingEvent.const_392,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_392:
      ...
      {
         this.var_59 = param2 as IRoomWidgetFactory;
         Component(this.var_59).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_59).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_59).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_59).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_178 = param2 as IHabboHelp;
         this.var_178.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_178.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_851,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_318,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_276 = param2 as IAdManager;
         this.var_276.events.addEventListener(AdEvent.const_444,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_608)
         {
            this.var_608.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_176 != null && !Boolean(this.var_176.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_500 > -1 && _loc2_ < this.var_500)
         {
            ++this.var_1797;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1797);
         }
         if(this.var_500 > -1 && _loc2_ - this.var_500 > 15000)
         {
            ++this.var_1796;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1796);
         }
         this.var_500 = _loc2_;
         if(this.var_254 != null)
         {
            this.var_254.update(param1,this.var_500);
         }
         if(this.var_253 != null)
         {
            this.var_253.update(param1,this.var_500);
         }
         if(this.var_607 != null)
         {
            this.var_607.trackUpdate(param1,this,this.var_500);
         }
         if(this.var_606 != null)
         {
            this.var_606.update(this.var_500);
         }
      }
   }
}
