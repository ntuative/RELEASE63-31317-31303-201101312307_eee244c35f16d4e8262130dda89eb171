package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      {
         var _loc1_:int = this.var_214.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            (this.var_214.pop() as HabboNotificationItemView).dispose();
            _loc2_++;
         }
         this._disposed = true;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2614,this.var_418,this.var_165);
         _loc2_.showItem(param1);
         _loc2_.reposition(this.getNextAvailableVerticalPosition());
         this.var_214.push(_loc2_);
         this.var_214.sortOn("verticalPosition",Array.NUMERIC);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            (this.var_214[_loc2_] as HabboNotificationItemView).update(param1);
            _loc2_++;
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_214.length)
         {
            _loc3_ = this.var_214[_loc2_] as HabboNotificationItemView;
            if(_loc3_.ready)
            {
               _loc3_.dispose();
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_214.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_631 + const_1322;
            _loc2_++;
         }
         return _loc1_;
      }
