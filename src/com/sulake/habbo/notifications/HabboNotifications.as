package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1281:String = "pixelbalance";
      
      private static const const_1278:String = "badges";
      
      private static const const_1279:String = "selectbadge";
      
      private static const const_1282:String = "inventory";
      
      private static const const_1280:String = "selectfurni";
      
      private static const const_1283:String = "credits";
      
      private static const const_1277:String = "friendlist";
      
      private static const const_1276:String = "pet_inventory";
      ...
      private var var_718:IHabboToolbar;
      ...
      private var var_495:HabboNotificationViewManager;
      
      private var var_207:HabboAlertDialogManager;
      
      private var var_719:ParkBusDialogManager;
      
      private var var_2447:Boolean;
      
      private var var_911:ClubGiftNotification;
      
      private var var_913:ClubEndingNotification;
      
      private var var_912:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_914);
         }
         var _loc6_:Map = this.var_914["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_718)
         {
            this.var_718.release(new IIDHabboToolbar());
            this.var_718 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_914["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1121.push(_loc8_);
         return this.var_1121.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1121.splice(0,1);
      ...
      {
         this.var_718 = IHabboToolbar(param2);
         this.var_718.events.addEventListener(HabboToolbarEvent.const_66,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_66)
         {
            ...
            this.var_495 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_914["styles"],this.var_914["view"],this.var_718);
            ...
            registerUpdateReceiver(this.var_495,1);
            registerUpdateReceiver(this,2);
            this.var_395.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImage);
            this.var_718.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1371[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_395);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1371[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1371[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1601);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_395.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_974);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_974);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1461);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_447.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_90)
               {
                  _loc9_ = this.var_395.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_83)
               {
                  _loc9_ = this.var_395.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_395.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1566,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_90:
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1413)
         {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_912 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         if(this.var_495.isSpaceAvailable() && this.var_1121.length > 0)
         {
            this.var_495.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      {
         if(param1 != null && this.var_495 != null)
         {
            this.var_495.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_402;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_395;
            }
            return 1;
         }
         return 1;
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_719 == null)
         {
            this.var_719 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_719 != null)
         {
            this.var_719.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_447.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_989,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_447.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2447)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_980);
            this.var_2447 = true;
      ...
      {
         if(param2.type == WindowEvent.const_187 || param2.type == WindowEvent.const_845)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_911 && this.var_911.visible)
         {
            return;
         }
         this.var_911 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
