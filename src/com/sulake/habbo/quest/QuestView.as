package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1658:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_93.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this._view = this.var_61.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_1658 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            case QuestTypeEnum.GIVE_BADGE:
               this._view = this.var_61.controller.questEngine.getXmlWindow("QuestTypeGiveBadge");
               this.var_1658 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            default:
      ...
      private function localize() : void
      {
         ...
         {
            _loc33_ = this.var_61.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_93.roomItemTypeName);
            if(_loc33_)
            {
               _loc34_ = this.var_61.controller.questEngine.roomEngine.getFurnitureImage(_loc33_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1659 = _loc34_.id;
               if(_loc34_ && _loc34_.data)
               {
                  this.imageReady(_loc34_.id,_loc34_.data);
               }
               this.var_61.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc33_.title);
            }
         }
         ...
         {
            case QuestStatusEnum.const_437:
            ...
            case QuestStatusEnum.const_177:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_824:
               this.setText("quest.status","quest.completed");
               _loc17_.visible = true;
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_189:
