package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2683:uint = 2;
      
      private var var_2682:uint = 0;
      
      private var var_874:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1489 = param1.roomItemTypeName;
         this.var_1491 = param1.rewardCurrencyAmount;
         this.var_1902 = new Date();
         this.var_1902.setTime(param1.endDateTimeStamp);
         this.var_648 = param1.localizationCode;
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_61.code,this.var_648].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_182)
            {
               this.var_874.style = this.var_2682;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_182)
            {
               this.var_874.style = this.var_2683;
            }
         }
      }
