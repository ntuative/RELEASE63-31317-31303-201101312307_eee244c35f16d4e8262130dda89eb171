package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_165 != null && this.var_1017)
         {
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1554);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_665 == InventoryCategory.const_163)
            {
               this.toggleCategoryView(InventoryCategory.const_163);
            }
            else if(this.var_665 == InventoryCategory.const_81)
            {
