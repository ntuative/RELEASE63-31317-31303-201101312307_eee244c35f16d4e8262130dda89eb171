package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_416 = new Timer(1000,1);
         this.var_416.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_395.events.addEventListener(BadgeImageReadyEvent.const_128,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_416)
            {
               this.var_416.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_416.reset();
               this.var_416 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_416.running);
