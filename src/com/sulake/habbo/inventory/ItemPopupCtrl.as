package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_922:int = 5;
      
      private static const const_1268:int = 250;
      
      private static const const_1270:int = 100;
      
      private static const const_1269:int = 180;
      
      private static const const_1267:int = 200;
      ...
      {
         this.var_336 = new Timer(const_1268,1);
         this.var_337 = new Timer(const_1270,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this.var_337.addEventListener(TimerEvent.TIMER,this.onHideTimer);
         var _loc3_:BitmapDataAsset = this._assets.getAssetByName("popup_arrow_right_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_901 = _loc3_.content as BitmapData;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_337.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_337.stop();
            this.var_337 = null;
         }
         this._assets = null;
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1269,param3.width),Math.min(const_1267,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1733);
         switch(this.var_1733)
         {
            case const_1116:
               this.var_74.x = -1 * this.var_74.width - const_922;
               break;
            case const_567:
               this.var_74.x = this._parent.width + const_922;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1116:
               _loc2_.bitmap = this.var_901.clone();
               _loc2_.width = this.var_901.width;
               _loc2_.height = this.var_901.height;
               _loc2_.y = (this.var_74.height - this.var_901.height) / 2;
            ...
            case const_567:
               ...
               _loc2_.y = (this.var_74.height - this.var_712.height) / 2;
