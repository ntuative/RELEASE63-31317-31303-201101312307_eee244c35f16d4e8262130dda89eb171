package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_915:uint = 4284532064;
      ...
      private var var_397:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_397 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_187)
            {
               this.var_187.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_187.stop();
               this.var_187 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1673 = this.createMinimizedWindow();
         }
         if(!this.var_2317)
         {
            return this.var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_915) : uint(const_916);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_915) : uint(const_916);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_187 = new Timer(1000,3);
            this.var_187.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_187.reset();
         this.var_187.repeatCount = 3;
         this.var_187.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_187.currentCount));
         if(this.var_187.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_152)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1021)
            {
            ...
            this.var_397.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_567);
            this.var_397.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_397.hideDelayed();
         }
      }
