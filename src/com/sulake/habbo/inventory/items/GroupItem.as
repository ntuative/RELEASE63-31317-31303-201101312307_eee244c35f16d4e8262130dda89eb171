package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1428:Number;
      
      protected var var_790:int = 0;
      
      protected var var_642:BitmapData;
      ...
      protected var var_2714:BitmapData;
      
      private const const_1948:int = 8947848;
      
      private const const_1949:int = 13421772;
      
      private const const_1686:Number = 1;
      
      private const const_1687:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1428));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_685)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1687;
               _loc1_.blend = this.const_1687;
            }
            else
            {
               this._window.blend = this.const_1686;
               _loc1_.blend = this.const_1686;
            }
         }
         if(this.isSelected)
         {
