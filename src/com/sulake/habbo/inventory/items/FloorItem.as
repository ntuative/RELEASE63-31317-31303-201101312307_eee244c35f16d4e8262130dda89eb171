package com.sulake.habbo.inventory.items
{
   public class FloorItem implements IItem
   {
      ...
      protected var var_2706:Boolean;
      
      protected var var_2705:Boolean;
      
      protected var var_2580:Boolean;
      
      protected var var_2704:Boolean;
      
      protected var var_2703:int;
      
      protected var var_2575:int;
      
      protected var var_2578:int;
      
      protected var var_2581:int;
      
      protected var var_1890:String;
      ...
      public function FloorItem(param1:int, param2:int, param3:int, param4:int, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:String, param10:Number, param11:int, param12:int, param13:int, param14:int, param15:String, param16:int)
      {
         ...
         this.var_1428 = param10;
         this.var_2703 = param11;
         this.var_2575 = param12;
         this.var_2578 = param13;
         this.var_2581 = param14;
         this.var_1890 = param15;
         this.var_2322 = param16;
      }
