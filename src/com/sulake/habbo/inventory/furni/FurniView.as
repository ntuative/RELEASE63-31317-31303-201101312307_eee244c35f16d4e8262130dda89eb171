package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1649:int = 42;
      
      private const const_1646:int = 120;
      ...
      private var var_698:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_444.add(FurniModel.const_43,new FurniGridView(this.var_64,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_444.add(FurniModel.const_47,new FurniGridView(this.var_64,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_444.getValue(this.var_380);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_64.getCategoryContent(this.var_380);
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_43,FurniModel.const_47];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_444.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_444.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_444.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_64.getGroupItemInIndex(_loc3_,this.var_380);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_402)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_399)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_395)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_152)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_698 && this.var_698.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1646)
         {
            _loc3_ = this.const_1646;
         }
         else if(_loc3_ < this.const_1649)
         {
            _loc3_ = this.const_1649;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_359);
            }
         }
      }
   }
