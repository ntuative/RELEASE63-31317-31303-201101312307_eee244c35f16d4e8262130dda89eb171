package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_43:String = "floor";
      
      public static const const_47:String = "wall";
      
      public static const const_359:String = "pets";
      
      private static const const_1257:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_241,this.onObjectPlaced);
         this._catalog = param7;
         this.var_576 = new Timer(const_1257,1);
         this.var_576.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2303 = XML(_loc9_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine);
         this._view.switchCategory(const_43);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_241,this.onObjectPlaced);
               }
            ...
            {
               this.var_576.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_576.stop();
               this.var_576 = null;
            }
            if(this.var_186 != null)
            {
               this.var_186.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_186.stop();
               this.var_186 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_402)
         {
         ...
         else if(param3 == FurniCategory.const_399)
         {
         ...
         else if(param3 == FurniCategory.const_395)
         {
         ...
         if(this.var_870 == null)
         {
            this.var_870 = this._windowManager.buildFromXML(this.var_2303) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_870.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_43,const_47];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_186 = new Timer(param1,1);
            this.var_186.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_186.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_338);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_43,const_47];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_43,const_47];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_480.add(const_43,new Array());
         this.var_480.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_152)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_399 || _loc3_.category == FurniCategory.const_402 || _loc3_.category == FurniCategory.const_395)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1328 && param1.type == RoomEngineObjectEvent.const_241)
         {
            this.var_1328 = false;
         }
      }
      ...
      {
         return this.var_480.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_480.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_480.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_685)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
