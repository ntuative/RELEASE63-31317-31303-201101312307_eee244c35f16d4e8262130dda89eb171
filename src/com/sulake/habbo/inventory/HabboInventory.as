package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1055:IRoomSession;
      ...
      private var var_181:Boolean;
      
      private var var_2583:Boolean;
      
      private const const_1976:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_98,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_518,this.roomSessionEventHandler);
      ...
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_628));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_301));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_353));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_163));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_338) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_98,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_518,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_395 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this.var_165)
         {
            return;
         }
         ...
         this.var_49.add(InventoryCategory.const_338,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_301,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_628,_loc4_);
         ...
         this.var_49.add(InventoryCategory.const_353,_loc5_);
         ...
         this.var_49.add(InventoryCategory.const_163,_loc8_);
         this.var_181 = true;
         if(this.var_2583)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_941.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_941.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_941.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_941.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1976);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_768));
      }
