package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_731:ISessionDataManager;
      
      private var var_2502:FriendListLookAndFeel;
      
      private var var_403:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1773:OpenedToWebPopup;
      
      private var var_2462:int;
      
      var var_94:FriendCategories;
      
      private var var_349:FriendRequests;
      
      private var var_1774:AvatarSearchResults;
      
      private var var_165:IHabboToolbar;
      
      private var var_881:IHabboNotifications;
      
      private var var_601:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2502 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1774 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_601.stop();
            this.var_601.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_601 = null;
         }
         ...
         if(this.var_881)
         {
            this.var_881.release(new IIDHabboNotifications());
            this.var_881 = null;
         }
         if(this.var_165)
         {
         ...
         if(this.var_731)
         {
            this.var_731.release(new IIDSessionDataManager());
            this.var_731 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1773 = new OpenedToWebPopup(this);
         }
         this.var_1773.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_97);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_349.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_287,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1119.createAvatarImage(param1,AvatarScaleType.const_84,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_176.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_176.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_881 = param2 as IHabboNotifications;
      ...
      {
         this.var_731 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_349 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_1032,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_389,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_94.addFriend(new Friend(_loc4_));
         }
         this.var_403 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_601)
         {
            this.var_601 = new Timer(120000);
            this.var_601.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_601.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_389);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_403.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_392));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_349.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_349.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_403.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_349.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_403.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1774.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_403.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_731 || !this.var_349)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_731.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_349.vipLimit;
         }
         else if(this.var_731.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_349.clubLimit;
         }
         if(_loc2_ > this.var_349.limit)
         {
            this.var_349.limit = _loc2_;
         }
      }
