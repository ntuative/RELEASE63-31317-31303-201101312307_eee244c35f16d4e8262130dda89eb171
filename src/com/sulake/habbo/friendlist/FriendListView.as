package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1644:String = "noconvinfo";
      
      private static const const_1645:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1237:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1237 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_861 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_237 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1237.prepare(this.var_861);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1076,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_996,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_696,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_662,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_696,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_662,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1238 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1238.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1512 == -1 ? 0 : int(this.var_16.height - this.var_1512);
         var _loc4_:int = this.var_1514 == -1 ? 0 : int(this.var_16.width - this.var_1514);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1128,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_696,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1076,false);
         ...
         this.var_1512 = this.var_16.height;
         this.var_1514 = this.var_16.width;
