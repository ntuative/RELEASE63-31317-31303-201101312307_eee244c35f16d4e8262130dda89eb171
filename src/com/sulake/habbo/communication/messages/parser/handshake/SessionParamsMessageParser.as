package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_1958:Boolean;
      
      protected var var_1959:Boolean;
      
      protected var var_1977:String;
      
      protected var var_1955:Boolean;
      
      protected var var_1956:Boolean;
      
      protected var var_1957:Boolean;
      
      protected var _confPartnerIntegration:Boolean;
      
      protected var var_2711:Boolean;
      
      protected var var_2712:String;
      
      protected var var_2710:Boolean;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_1958 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_1959 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
               ...
               case 3:
                  _loc5_ = param1.readInteger();
                  this.var_1956 = _loc5_ > 0;
                  break;
               case 4:
                  _loc5_ = param1.readInteger();
                  this.var_1957 = _loc5_ > 0;
                  break;
               case 5:
