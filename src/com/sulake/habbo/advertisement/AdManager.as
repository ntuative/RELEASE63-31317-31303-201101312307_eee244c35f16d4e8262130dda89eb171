package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1000:BitmapData = null;
      ...
      {
         this.var_279 = param2 as IHabboCommunicationManager;
         if(this.var_279 == null)
         {
            return;
         }
         this._connection = this.var_279.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2041 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2042 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_198 != null && this.var_198.running)
         {
            this.var_198.reset();
            return false;
         }
         ...
         if(this.var_1516 > 0 && this.var_1515 >= this.var_1516)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_999;
         if(_loc1_ > this.var_2041)
         {
            ++this.var_1515;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1240 = _loc2_.imageUrl;
         this.var_2040 = _loc2_.clickUrl;
         this.var_999 = getTimer();
         if(this.var_1240 != "")
         {
            _loc3_ = this.var_1240;
            ...
            {
               this.var_198 = new Timer(this.var_2042,1);
               this.var_198.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_198.running)
            {
               this.var_198.reset();
            }
            this.var_198.start();
            _loc4_ = new URLRequest(this.var_1240);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_509,0,0,param1.bitmapData,this.var_2040));
            this.var_999 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1239 = _loc2_.imageUrl;
         this.var_1517 = _loc2_.clickUrl;
         if(this.var_1239 != "" && this.var_1517 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1239);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_444,0,0,_loc4_,this.var_1517,this.var_1000,this.var_1001));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1000 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1001 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
