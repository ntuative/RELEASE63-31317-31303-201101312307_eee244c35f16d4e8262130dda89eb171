package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_405:uint = 3;
      
      private static const const_1218:uint = 1;
      ...
      private var var_836:IWindowRenderer;
      
      private var var_835:ISkinContainer;
      
      private var var_310:Array;
      
      private var var_1271:IEventDispatcher;
      
      private var var_1032:Boolean = false;
      
      private var var_1578:ProfilerOutput;
      
      private var var_1270:ProfilerAgentTask;
      
      private var var_1272:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_835 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_836 = new WindowRenderer(this.var_835);
         this.var_183 = new Array(const_405);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_405)
         {
            this.var_183[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_836,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_183[const_1218];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_401,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1547,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1578)
            {
               this.var_1578 = new ProfilerOutput(context,this,this.var_836);
            }
            this.var_1578.profiler = _loc3_;
            this.var_1270 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1270);
            this.var_1272 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1272);
            this.var_1032 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_183)
            {
               ...
               {
                  IDisposable(this.var_183.pop()).dispose();
               }
            }
            this.var_183 = null;
            if(this.var_310)
      ...
      {
         var _loc3_:Dictionary = this.var_310[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_310[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_835.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_183[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_183[param2].getDesktopWindow();
      ...
      {
         return this.var_183[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_183[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_183[param1];
      ...
      public function method_11(param1:String, param2:String, param3:String, param4:String, param5:uint, param6:Function) : IAlertDialogWithLink
      {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_364.length > 0)
         {
            this.var_1271.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_405 - 1;
            while(_loc2_ >= 0)
            {
               this.var_183[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1032)
         ...
         this.var_1271.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_405)
         {
            this.var_183[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1032)
         {
         ...
         if(WindowContext.var_364.length > 0)
         {
            WindowContext.var_364.flush();
         }
         this.var_1271.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1401,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1522,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1384,new Date().getTime().toString());
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_426,
            "style":WindowStyle.const_176,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
