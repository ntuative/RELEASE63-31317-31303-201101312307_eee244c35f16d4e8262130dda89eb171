package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_888:int = 60;
      
      private static const const_890:int = 3600;
      
      private static const const_889:int = 86400;
      
      private static const const_887:int = 31536000;
      ...
      {
         if(param1 < 2 * const_888)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_890)
         {
            return Math.round(param1 / const_888) + " mins ago";
         }
         if(param1 < 2 * const_889)
         {
            return Math.round(param1 / const_890) + " hours ago";
         }
         if(param1 < 2 * const_887)
         {
            return Math.round(param1 / const_889) + " days ago";
         }
         return Math.round(param1 / const_887) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1020.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1020.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1168,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1236),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1236),this._callerFrame,this.var_1019,false,true);
      }
