package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1080:int = 3;
      
      public static const const_639:int = 4;
      
      public static const const_1168:int = 5;
      
      public static const const_1609:int = 6;
      
      public static const const_1582:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1527:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1560[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1560[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
