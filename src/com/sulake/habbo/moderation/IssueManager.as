package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1121:String = "issue_bundle_open";
      
      public static const const_818:String = "issue_bundle_my";
      
      public static const const_1136:String = "issue_bundle_picked";
      
      public static const const_1441:int = 15000;
       
      
      private var var_62:ModerationManager;
      
      private var var_590:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_590 = new IssueBrowser(this,this.var_62.windowManager,this.var_62.assets);
         this.var_1112 = [];
         this.var_1113 = [];
         this.var_904 = new Map();
         this.var_2418 = parseInt(this.var_62.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1737 = new Timer(const_1441,0);
         this.var_1737.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1737.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1112 = this.var_1112.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1113 = this.var_1113.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_590 == null || !this.var_590.isOpen())
         {
            this.var_62.soundManager.playSound(HabboSoundTypesEnum.const_1003);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_905.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_905.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_100)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_905.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2419++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_905.add(param1.issueId,_loc2_);
         ...
         if(this.var_1112.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_818);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1113.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2418);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_904.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_904.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_905.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_100.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_904.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_904.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_904.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
