package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_924:Array = [];
      
      private static var var_1770:int = 1000;
      
      private static var var_923:Array = [];
      
      private static var var_1771:int = 200;
      ...
      {
         this.var_730 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_729 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_439 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1672);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_924.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_729.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_924.length < var_1770)
         {
            ...
            param1.width = this.var_729.width;
            param1.height = this.var_729.height;
            var_924.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_923.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_730.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_923.length < var_1771)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_730.width;
            param1.height = this.var_730.height;
            var_923.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1772[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1385.getValue(param2.chatterName))
            {
               this.var_1385.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1385.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1384)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1383)
         {
