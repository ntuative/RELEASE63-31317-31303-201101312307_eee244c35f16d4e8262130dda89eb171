package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_800:Array = [];
      
      private static var var_1482:int = 200;
      ...
      {
         this.var_647 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1609;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_800.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_647.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_800.length < var_1482)
         {
            ...
            param1.width = this.var_647.width;
            param1.height = this.var_647.height;
            var_800.push(param1);
         }
         else
         {
