package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_489:UserInfoCtrl;
      
      private var var_1104:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_489 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         this.var_1104 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
         this.var_489.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1104.load(_loc4_,this.var_150.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_62 != null && this.var_62.issueManager != null && this.var_150 != null)
         {
            this.var_62.issueManager.removeHandler(this.var_150.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_150.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_150.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.closeBundle(this.var_150.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.issueManager.releaseBundle(this.var_150.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_62,WindowTracker.const_1080,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_489 = new UserInfoCtrl(this._window,this.var_62,_loc3_.message);
            this.var_489.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
