package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_592:int = 20;
      ...
      private var var_2786:BitmapData;
      
      private var var_2787:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1829 = this.var_590.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_590.assets.getAssetByName(_loc12_) as BitmapDataAsset;
