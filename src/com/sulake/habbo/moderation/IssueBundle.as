package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_660:IssueMessageData = null;
      
      private var var_661:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2067 = param2.pickerUserId;
         this.var_2068 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1014 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1013;
         }
         if(this.var_660 == null || param1.timeStamp < this.var_660.timeStamp)
         {
            this.var_660 = param1;
         }
         if(this.var_661 == null || param1.priority > this.var_661.timeStamp)
         {
            this.var_661 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1014 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1013;
            }
            if(this.var_660 == _loc2_)
            {
               this.var_660 = null;
            }
            if(this.var_661 == _loc2_)
            {
               this.var_661 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_661;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_660;
         if(_loc2_ == null)
         {
