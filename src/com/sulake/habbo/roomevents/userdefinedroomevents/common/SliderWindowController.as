package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1010,param1);
         this.var_816 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_816);
         }
      ...
      {
         return int(this.var_1520 * (Number(param1 - this._minValue) / (this.var_1010 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1520 * (this.var_1010 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_817)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_193)
            {
               this.var_817 = false;
            }
         }
         if(!this.var_817 || param1.type != WindowEvent.const_348)
         {
            return;
         }
         if(this.var_540 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_540 != 0)
            {
               _loc3_ = this.var_816 + this.var_540;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_657 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_657.width,this.var_657.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_657,this.var_657.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_658 != null)
            {
               ...
               this.var_1520 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_657 = BitmapData(_loc2_.content);
