package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_117.push(new ActorIsOnFurni());
         this.var_117.push(new FurnisHaveAvatars());
         this.var_117.push(new StatesMatch());
         this.var_117.push(new TimeElapsedMore());
         this.var_117.push(new TimeElapsedLess());
         this.var_117.push(new UserCountIn());
         this.var_117.push(new ActorIsInTeam());
         this.var_117.push(new HasStackedFurnis());
         this.var_117.push(new StuffTypeMatches());
      }
