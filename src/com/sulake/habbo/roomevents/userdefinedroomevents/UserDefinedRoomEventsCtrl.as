package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_90:HabboUserDefinedRoomEvents;
      
      private var _window:IFrameWindow;
      
      private var var_89:IWindowContainer;
      
      private var var_1834:TriggerConfs;
      
      private var var_1832:ActionTypes;
      ...
      private var var_178:UserDefinedRoomEventsHelp;
      
      private var var_1163:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1834 = new TriggerConfs();
         this.var_1832 = new ActionTypes();
         this.var_1833 = new ConditionTypes();
         this.var_260 = new Dictionary();
         super();
         this.var_90 = param1;
         this.var_755 = new RoomObjectHightLighter(param1);
         this.var_178 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_90.getXmlWindow("ude_main"));
         this.var_89 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_89,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_89,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_89,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_89,"apply_snapshot_txt"),this.onApplySnapshot);
         this.find(this.var_89,"helplink").mouseThreshold = 0;
         this.find(this.var_89,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1163 = new SliderWindowController(this.var_90,IWindowContainer(this.find(this.var_89,"delay_slider_container")),this.var_90.assets,0,20,1);
         this.var_1163.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1163.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_90.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_90.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_755.hideAll(this.var_260);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_60 as TriggerDefinition != null)
         {
            this.var_90.send(new UpdateTriggerMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_60 as ActionDefinition != null)
         {
            this.var_90.send(new UpdateActionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_60 as ConditionDefinition != null)
         {
            this.var_90.send(new UpdateConditionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1163.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_178.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_90.send(new ApplySnapshotMessageComposer(this.var_60.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1834);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_89,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_89,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_89,3,5);
         this.var_89.height = Util.getLowestPoint(this.var_89) + 1;
      }
      
      private function getElementName(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_90.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      private function method_10(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_90.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_89,"header_container"));
         ...
         this.setText(_loc3_,"conf_desc_txt",this.method_10(this.var_60.stuffTypeId));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_89,"action_inputs_container"));
         if(this.var_60 as ActionDefinition == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_90.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_90.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_90.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_90.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_90.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_90.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      
      private function refreshWarning(param1:String, param2:String) : void
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_89,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_89,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_89.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_89.findChildByName("custom_inputs_container"));
         var _loc4_:String = _loc1_.getKey() + _loc2_.code;
         var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_90.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_90);
         }
         return _loc5_;
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_89.findChildByName("select_furni_container"));
         if(!this.isStuffSelectionMode())
         {
            _loc1_.visible = false;
            return;
         ...
         this.var_90.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_90.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
   }
}
