package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1304:int = 30;
      
      private static const const_1302:int = 253;
      
      private static const const_1303:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_183);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1304)
         {
