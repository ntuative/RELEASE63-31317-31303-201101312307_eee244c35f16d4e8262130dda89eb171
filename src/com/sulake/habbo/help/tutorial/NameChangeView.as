package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1309:uint = 13232628;
      
      private static var var_1637:uint = 11129827;
      ...
      private var var_1072:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1635 = this._window.content.getChildAt(0) as IWindowContainer;
         }
         this._controller.localization.registerParameter("tutorial.name_change.current","name",this._controller.method_4);
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.main");
         this.showView(this.var_1635);
      }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_691)
         {
            this.var_691 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_691)
            {
               return;
            }
            this._window.content.addChild(this.var_691);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_692)
         {
            this.var_692 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_692)
            {
               return;
            }
            this._window.content.addChild(this.var_692);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_692.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_470;
         }
         this.showView(this.var_692);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_470);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_964 || param1 == ChangeUserNameResultMessageEvent.var_965)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1072 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1072.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1309;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_470 = this._controller.method_4;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_470);
               break;
