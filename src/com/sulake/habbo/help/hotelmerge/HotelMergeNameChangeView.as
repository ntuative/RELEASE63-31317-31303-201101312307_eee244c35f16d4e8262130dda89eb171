package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      public function showMainView() : void
      {
         ...
         this._controller.localization.registerParameter("hotel_merge.name_change.current","name",this._controller.method_4);
      ...
      private function showSelectionView() : void
      {
         if(!this.var_691)
         {
            this.var_691 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_691)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_692)
         {
            this.var_692 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_692)
            {
               return;
            }
