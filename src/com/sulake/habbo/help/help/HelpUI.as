package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1685:int = 0;
      ...
      {
         this.var_348 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201101312303));
         this.var_165 = param5;
         this.var_101 = new Map();
         this.var_101.add(HabboHelpViewEnum.const_1380,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_183,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_442,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_297,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_698,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_358,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_802,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_230,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_101.add(HabboHelpViewEnum.const_1062,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_101.add(HabboHelpViewEnum.const_999,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_101.add(HabboHelpViewEnum.const_849,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_101.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_101.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_496.length == 0 || param1 != this.var_348)
            {
               this.var_496.push(this.var_348);
            }
         }
         this.var_348 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_348);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_230:
               this.showUI(HabboHelpViewEnum.const_230);
               break;
            case CallForHelpResultEnum.const_1053:
               this.showUI(HabboHelpViewEnum.const_999);
               break;
            case CallForHelpResultEnum.const_1186:
               this.showUI(HabboHelpViewEnum.const_1062);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_101.getValue(HabboHelpViewEnum.const_183) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_428));
      }
      ...
      public function method_5(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_101.length)
         {
            _loc3_ = this.var_101.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_101.getValue(this.var_348);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1768 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1769;
         this._window.width = _loc1_.width + this.var_1768;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_496.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_348 == HabboHelpViewEnum.const_183)
         {
            return;
         }
         if(this.var_600.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_600.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_600.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_347.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_600[1],this.var_600[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_600[0],this.var_600[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_348 == HabboHelpViewEnum.const_183 || this.var_496.length == 0)
         {
            return;
         }
         if(this.var_347 == null)
         {
            ...
            this.var_347 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_347.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_347.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_347 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_347 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_347 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
