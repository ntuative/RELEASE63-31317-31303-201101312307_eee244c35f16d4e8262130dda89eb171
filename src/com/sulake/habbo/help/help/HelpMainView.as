package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1286:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc9_ != null)
               {
                  _loc10_ = "<a href=\"" + _loc8_ + "\">" + _loc9_ + "</a>";
                  _loc2_.htmlText = _loc10_;
               }
            }
         }
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1286)
         {
         ...
         if(_loc7_ != null)
         {
            _loc11_ = assetLibrary.getAssetByName("guidebot_icon_png").content as BitmapData;
            _loc7_.bitmap = new BitmapData(_loc7_.width,_loc7_.height,true);
            _loc7_.bitmap.copyPixels(_loc11_,_loc11_.rect,new Point(0,0));
         }
         super.render();
         this.update();
      }
      ...
      private function onCallForHelp(param1:WindowMouseEvent) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_358);
      }
      
      private function onReportUser(param1:WindowMouseEvent) : void
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_849);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            main.tellUI(HabboHelpViewEnum.const_249,_loc6_);
         }
      }
   }
}
