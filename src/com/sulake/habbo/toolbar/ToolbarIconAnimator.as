package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            this.var_949 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1429 == true || this.var_950 == 0)
         {
      ...
      {
         return this.var_1429 == false && this.var_950 == 1 && this.var_1665 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_949.width),Math.max(param2.height,this.var_949.height));
            _loc3_.copyPixels(this.var_949,this.var_949.rect,new Point(0,0));
