package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1299:CutToWidth = new CutToWidth();
      
      private static var var_1300:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1299.beforeSearch(param2,param1,param3);
         binarySearch(var_1299,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1300.beforeSearch(param2,param1,param3);
         binarySearch(var_1300,param2.length - 1);
      }
