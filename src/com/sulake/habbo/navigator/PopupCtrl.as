package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_413 = new Timer(500,1);
         this.var_350 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_969 = param4;
         this.var_2506 = param2;
         this._popupIndentLeft = param3;
         this.var_413.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_413)
         {
            this.var_413.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_413.reset();
            this.var_413 = null;
         }
         if(this.var_350)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_51 == null)
         {
            this.var_51 = IWindowContainer(this._navigator.getXmlWindow(this.var_969));
            this.var_51.visible = false;
            this.var_51.setParamFlag(HabboWindowParam.const_36,true);
         ...
         this.var_51.x = _loc2_.x + this.var_2506 + param1.width;
