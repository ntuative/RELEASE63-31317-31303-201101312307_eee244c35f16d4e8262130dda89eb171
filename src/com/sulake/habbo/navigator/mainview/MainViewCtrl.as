package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1018:int = 4;
      
      private static const const_905:int = 1;
      
      private static const const_578:int = 2;
      
      private static const const_906:int = 3;
      
      private static const const_1243:int = 4;
      ...
      private var var_859:PopularTagsListCtrl;
      
      private var var_860:GuestRoomListCtrl;
      
      private var var_1067:OfficialRoomListCtrl;
      ...
      private var var_1069:Boolean = true;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_859 = new PopularTagsListCtrl(this._navigator);
         this.var_860 = new GuestRoomListCtrl(this._navigator);
         this.var_1067 = new OfficialRoomListCtrl(this._navigator);
         this.var_439 = new Timer(300,1);
         this.var_439.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_439)
            {
               this.var_439.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_439.reset();
               this.var_439 = null;
            }
            if(this.var_859)
      ...
      public function open() : void
      {
         ...
         if(_loc1_)
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,this.var_16));
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_202 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_184 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_237 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1306 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1068 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1068)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1068.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_620,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1585,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_168,["custom_content","list_content"],this.var_202.y,8);
         this.var_184.height = this.var_184.height + _loc1_ - this.var_184.y - this.var_237.height + this.var_2237;
         Util.moveChildrenToColumn(this.var_168,["list_content","custom_footer"],this.var_184.y,0);
         this.var_2237 = this.var_237.height;
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_202);
      ...
      {
         this.refreshList(param1,param2,this.var_860,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_859,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1067,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_565 == const_905)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_184.blend - _loc2_));
            this.var_184.blend = _loc3_;
            this.var_202.blend = !!this.var_1069 ? Number(_loc3_) : Number(1);
            this.var_237.blend = !!this.var_1069 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_565 = const_578;
            }
         }
         else if(this.var_565 == const_578)
         {
            if(this.var_1305 % 10 == 1)
            {
               this.var_1306.visible = !this.var_1306.visible;
            }
            ++this.var_1305;
            if(!this._navigator.data.isLoading())
            {
               this.var_565 = const_906;
            }
         }
         else if(this.var_565 == const_906)
         {
            this.refresh();
            this.var_565 = const_1243;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_859);
         this.refreshScrollbar(this.var_860);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1068,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1068,"icon_hotelview_reactive",param1,null,0);
      }
