package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomPasswordInput
   {
      ...
      private var var_1077:GuestRoomData;
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:IButtonWindow = this._window.findChildByName("HabboHelpCom_help_cfh_send_xml") as IButtonWindow;
         if(_loc2_ != null)
         {
      ...
      private function onTry(param1:WindowMouseEvent) : void
      {
         ...
         this._navigator.goToRoom(this.var_1077.flatId,true,_loc3_);
         this.hide();
      }
