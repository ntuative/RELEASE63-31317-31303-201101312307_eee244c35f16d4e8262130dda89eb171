package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1091:TextFieldManager;
      
      private var var_41:Array;
      
      private var var_1092:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
         ...
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,540,"t"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,512,"w"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,396,"x"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,440,"y"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,456,"z"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_54,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1092.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1682 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1682 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_168 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_53 = IItemListWindow(this.var_168.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_168.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1091 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_168.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_168.desktop,this.var_168.width,this.var_168.height);
         this.var_168.x = _loc4_.x;
         this.var_168.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1091.goBackToInitialState();
         this.var_1091.input.textBackgroundColor = 4294967295;
         this.var_1092 = this.var_41[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1091.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_168.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_168.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1091.getText();
         var _loc3_:String = "model_" + this.var_1092.name;
         if(!this.isMandatoryFieldsFilled())
         {
            return;
         }
         this._navigator.send(new CreateFlatMessageComposer(_loc2_,_loc3_));
         this.var_168.visible = false;
      }
