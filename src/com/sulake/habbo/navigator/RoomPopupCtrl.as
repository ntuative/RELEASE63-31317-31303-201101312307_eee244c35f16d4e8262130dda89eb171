package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_106:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2226 = new RoomThumbnailRenderer(param1);
         this.var_1134 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_166,this.var_106);
         if(this.var_106.ownerName != "" && this.var_106.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_166,!!this.var_106.event ? this.getEventCtg(this.var_106.categoryId) : this.getRoomCtg(this.var_106.categoryId));
         this.refreshRoomDesc(this.var_166,this.var_106);
         this.refreshExtraCont();
         this.refreshInfo(this.var_166,"trading_allowed",this.var_106.allowTrading);
         this.refreshInfo(this.var_166,"doormode_doorbell",this.var_106.doorMode == 1);
         this.refreshInfo(this.var_166,"doormode_password",this.var_106.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_166,this.var_106.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1134.refreshTags(_loc1_,this.var_106.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_106.score);
         if(this.var_106.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_106.eventCreationTime);
         }
         this.var_2226.refreshThumbnail(_loc1_,this.var_106.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_240,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
