package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_670:TextFieldManager;
      ...
      private var var_2122:IButtonWindow;
      ...
      {
         this.var_840.visible = false;
         this.var_1581.visible = true;
         this.var_2123.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_670.setText(param1.eventDescription);
      ...
      private function createEvent() : void
      {
         ...
         this.var_1581.visible = false;
         this.var_1273.visible = true;
         this.var_1275.visible = false;
         this.var_1274.visible = false;
         this.var_670.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_838.goBackToInitialState();
         this.var_839.goBackToInitialState();
         this.var_840.selection = 0;
      ...
      {
         var _loc1_:int = this.var_840.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_670.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_670.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1581 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2123 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1580 = ITextWindow(this.find("create_caption"));
            this.var_1582 = ITextWindow(this.find("edit_caption"));
            this.var_1273 = IButtonWindow(this.find("create_button"));
            this.var_1275 = IButtonWindow(this.find("edit_button"));
            this.var_2122 = IButtonWindow(this.find("cancel_button"));
            this.var_1274 = IButtonWindow(this.find("end_button"));
            this.var_840 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1273,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1275,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1274,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2122,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_670 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
