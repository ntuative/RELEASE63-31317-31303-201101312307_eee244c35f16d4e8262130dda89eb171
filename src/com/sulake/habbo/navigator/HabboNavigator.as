package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_288:MainViewCtrl;
      
      private var var_596:RoomInfoViewCtrl;
      
      private var var_1130:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_403:Tabs;
      ...
      private var var_2226:RoomThumbnailRenderer;
      
      private var var_959:GuestRoomPasswordInput;
      
      private var var_356:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_288 = new MainViewCtrl(this);
         this.var_596 = new RoomInfoViewCtrl(this);
         this.var_1130 = new RoomCreateViewCtrl(this);
         this.var_2226 = new RoomThumbnailRenderer(this);
         this.var_959 = new GuestRoomPasswordInput(this);
         this.var_356 = new GuestRoomDoorbell(this);
         this.var_403 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_287,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_596.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_288.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_288.startSearch(Tabs.const_226,Tabs.const_350,param1);
         this.var_288.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_288.startSearch(Tabs.const_306,Tabs.const_210);
         this.var_403.getTab(Tabs.const_306).tabPageDecorator.tabSelected();
      }
