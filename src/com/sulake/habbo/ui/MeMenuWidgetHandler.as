   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_309,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_768,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_672,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_165)
            {
               this.var_165.events.removeEventListener(HabboToolbarEvent.const_66,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_456,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_110,this.onHelpTutorialEvent);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_309,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_768,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_672,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_456,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_110,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1343)
            {
               _loc4_ = this._container.sessionDataManager.gender;
               _loc5_ = this._container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_52,_loc4_,this);
               if(_loc5_ != null)
               {
                  _loc5_.setDirection(AvatarSetType.const_46,3);
                  _loc1_ = _loc5_.getCroppedImage(AvatarSetType.const_46);
                  _loc5_.dispose();
               }
               this.var_1343 = _loc3_;
               this.var_1690 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1690;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + this.var_165 + " " + _loc6_);
            if(this.var_165 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1166,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               this.var_165.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_799);
         _loc1_.push(RoomWidgetDanceMessage.const_806);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_636);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_623);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_720);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_775);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_801);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_372);
         _loc1_.push(RoomWidgetStopEffectMessage.const_757);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1425);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1043);
         _loc1_.push(RoomWidgetToolbarMessage.const_676);
         _loc1_.push(RoomWidgetToolbarMessage.const_751);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_371);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1540);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1073);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_605);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_694);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_660);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1470);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_793);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_871);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_679);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_694:
               ...
               break;
            case RoomWidgetWaveMessage.const_799:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_806:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_636:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_623:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_720:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_372:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1047)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_185,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_801:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1097:
                        this._catalog.openCatalogPage(CatalogPageName.const_1463,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1044:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_301);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1438:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1501:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_775:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1043:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_605:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_676:
               ...
               break;
            case RoomWidgetToolbarMessage.const_751:
               ...
               {
                  this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_473,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_371:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_534));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_660:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_373,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_793:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_373,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_871:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_373,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_679:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_381:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_670));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_624));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_110:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_110));
               break;
