package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_709,RoomWidgetPresentOpenMessage.const_153,RoomWidgetPresentOpenedMessage.const_1382];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_276:
                  ...
                  if(_loc2_ != null)
                  {
                     this._name = "";
                     _loc4_ = null;
                     if(_loc2_.itemType == ProductTypeEnum.const_90)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_83:
                           if(_loc3_ != null && _loc3_.name == const_198)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_467,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_465,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1198)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_379:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_441,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
