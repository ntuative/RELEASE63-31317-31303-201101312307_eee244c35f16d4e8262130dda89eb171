package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_840,RoomWidgetEcotronBoxOpenMessage.const_706,RoomWidgetEcotronBoxOpenedMessage.const_1437];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_840:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_706:
