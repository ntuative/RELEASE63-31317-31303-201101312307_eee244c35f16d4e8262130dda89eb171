package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_445:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_445.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_445 = null;
         }
         if(this.var_43 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_445 == null)
         {
            this.var_445 = new Sprite();
            this.var_445.addChild(new Bitmap(this.var_43));
            this.var_445.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_445.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_43;
            }
         }
         _loc2_.setDisplayObject(this.var_445);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1218 != "")
         {
            HabboWebTools.openWebPage(this.var_1218);
         }
      }
   }
}
