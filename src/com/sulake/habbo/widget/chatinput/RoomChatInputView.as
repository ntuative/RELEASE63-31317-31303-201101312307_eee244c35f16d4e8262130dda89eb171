package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_899:int = 16;
      
      private static const const_1221:int = 40;
      
      private static const const_1661:int = 5;
      
      private static const const_1222:int = 20;
      ...
      private var var_295:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1036 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2162 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2160 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_59,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_162,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_45,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_121,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_348,this.onWindowMoved);
         this.var_1591 = true;
         this.var_455 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2161 = _loc2_.width + const_899 + _loc6_.width + const_1222;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1221,_loc8_.width) + const_899);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_295 = param1 - this.var_2161;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_295);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_295);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1036 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_455 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_550);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_295)
         {
