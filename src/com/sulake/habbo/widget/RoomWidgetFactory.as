package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2751:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2751 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_374:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this._localizations,this.var_124,this.var_2423++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this._localizations,this);
               break;
            case RoomWidgetEnum.const_501:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this._localizations,this.var_124,this._catalog);
               break;
            case RoomWidgetEnum.const_447:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this._localizations,events,this.var_124);
               break;
            ...
            case RoomWidgetEnum.const_508:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this._localizations,this.var_124);
               break;
            ...
            case RoomWidgetEnum.const_500:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this._localizations,this.var_124);
               break;
            case RoomWidgetEnum.const_735:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this._localizations,this.var_124);
               break;
            case RoomWidgetEnum.const_118:
               _loc2_ = new VoteWidget(this._windowManager,assets,this._localizations,this.var_124);
               break;
