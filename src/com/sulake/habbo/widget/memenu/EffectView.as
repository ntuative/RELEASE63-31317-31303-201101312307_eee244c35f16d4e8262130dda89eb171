package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_889:IWindow;
      
      private var var_295:Number;
      
      private var var_891:ITextWindow;
      
      private var var_187:Timer;
      
      private var var_890:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_187 = new Timer(1000);
         this.var_187.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_187.stop();
            this.var_187.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_187 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            if(this.var_170.isActive)
            {
               _loc2_ = this.var_170.secondsLeft / Number(this.var_170.duration);
               this.var_889.width = _loc2_ * this.var_295;
            }
            else
            {
               this.var_889.width = 0;
               this.var_187.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_891.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_891.text;
            if(this.var_170.isActive)
            {
               _loc2_ = this.var_170.secondsLeft;
               ...
               this.var_891.text = _loc1_;
            }
            else
            {
               this.var_891.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_170.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_170.isActive)
         {
         ...
         else
         {
            ...
            this.var_890 = this._window.findChildByName("effect_hilite");
            this.var_890.visible = false;
         }
         this.var_891 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_889 = this._window.findChildByName("loader_bar");
         if(this.var_889 != null)
         {
            this.var_295 = this.var_889.width;
            this.var_187.start();
            this.onUpdate();
         }
         if(this.var_170.icon)
         {
            this.setElementBitmap("effect_icon",this.var_170.icon);
         }
      }
