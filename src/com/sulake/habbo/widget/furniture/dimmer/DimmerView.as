package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_620:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1208,const_1207,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_620 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1425 = _loc2_.light;
         if(this.var_419 != null)
         {
            this.var_419.setValue(this.var_1425);
         }
         this.var_491 = this.colors.indexOf(_loc2_.color);
         if(this.var_620 != null)
         {
            this.var_620.setSelectedColorIndex(this.var_491);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1424 = XML(_loc1_.content);
         return this.var_1424;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_620 != null)
         {
            this.var_620.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
