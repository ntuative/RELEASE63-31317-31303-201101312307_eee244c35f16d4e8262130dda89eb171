package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_441,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_467,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_529,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_465,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_441,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_467,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_529,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_465,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_72:
               ...
               this.showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_467:
               if(!this.var_328)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_529:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_465:
               if(!this.var_328)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1208,const_1207,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_328 || this.var_329 == -1 || !this._controller)
         {
            return;
         }
         this.var_328 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_153,this.var_329);
