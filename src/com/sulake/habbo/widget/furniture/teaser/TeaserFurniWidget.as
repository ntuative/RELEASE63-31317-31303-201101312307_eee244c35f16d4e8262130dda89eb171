package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1654:int = 0;
      
      private const const_1656:int = 1;
      
      private const const_1655:int = 2;
      
      private const const_1651:int = 3;
      
      private const const_1653:int = 4;
      
      private const const_1938:int = 0;
      
      private const const_1939:int = 1;
      
      private const const_1937:int = 2;
      
      private const const_1936:int = 3;
      
      private const const_1934:int = 4;
      
      private const const_1942:int = 5;
      
      private const const_1657:String = "deco_img";
      
      private const const_1652:String = "dialog_bg";
      
      private const const_1935:String = "%campaign%_dialog_bg.png";
      
      private const const_322:String = "%campaign%_gift_package.png";
      
      private const const_1940:String = "%campaign%_gift_content.png";
      
      private const const_1941:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         this._imageUrlPath = this.var_124.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1258.length)
         {
            _loc2_ = this.var_1258.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_124 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_431,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_875,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_611,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_431,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_431:
               _loc2_ = this.const_1654;
               this.var_1259 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_611:
               ...
               {
                  _loc2_ = this.const_1653;
               }
               this.var_1259 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_875:
               _loc2_ = this.const_1656;
               this.var_329 = param1.objectId;
               this.var_1259 = param1.data;
               this.var_370 = param1.status;
         ...
         if(this._window && (this.var_1257 != _loc2_ || _loc3_ != this.var_141))
         {
         ...
         if(!this._window)
         {
            switch(this.var_1257)
            {
               case this.const_1654:
                  ...
                  this.sendConversionPoint("viral_" + this.var_141,"client.show.teaser");
                  break;
               case this.const_1656:
                  if(this.var_370 == this.const_1938)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.locked");
                     _loc2_ = this.const_322;
                  }
                  else if(this.var_370 == this.const_1939)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.unlocked");
                     _loc2_ = this.const_1940;
                  }
                  else if(this.var_370 == this.const_1937)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.no_fb");
                  ...
                  else if(this.var_370 == this.const_1936)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_370 == this.const_1934)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_370 == this.const_1942)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_141,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1935.replace("%campaign%",this.var_141);
            this.setDecoImage(_loc5_,this.const_1652);
            _loc2_ = _loc2_.replace("%campaign%",this.var_141);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_141,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_141,"client.start_post");
         var _loc4_:String = this.var_124.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_141,_loc2_,_loc3_,this.var_1259,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         this.hideInterface();
         this.sendConversionPoint("viral_" + this.var_141,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_810,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1258.push(new ImageDownloader(this,_assets,this.var_141,this._imageUrlPath,param1,param2));
            return;
         }
      ...
      {
         if(!this._window || this.var_141 != param1.campaignID)
         {
            return;
         }
