package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1960:uint = 11184810;
      
      private const const_1956:uint = 6710886;
      
      private const const_1958:uint = 3355443;
      
      private const const_1955:String = "level";
      
      private const const_1954:String = "experience";
      
      private const const_1961:String = "energy";
      
      private const const_1953:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1955,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1954,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1961,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1953,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_485 = param1.id;
         this.var_1340.remove(param1.id);
         this.var_1340.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1960);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1958);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1340.getValue(this.var_485) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_210.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_188 && this.var_188.getPetId() == this.var_485)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_546,this._widget.petData.ownerId);
