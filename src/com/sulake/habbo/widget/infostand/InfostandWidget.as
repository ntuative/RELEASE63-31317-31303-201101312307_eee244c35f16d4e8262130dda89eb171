package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1675:String = "infostand_user_view";
      
      private const const_1672:String = "infostand_furni_view";
      
      private const const_1673:String = "infostand_pet_view";
      
      private const const_1674:String = "infostand_bot_view";
      
      private var var_1089:InfoStandFurniView;
      ...
      private var var_1334:InfostandUserData;
      
      private var var_480:InfostandFurniData;
      
      private var var_1340:InfoStandPetData;
      ...
      private const const_1952:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1089 = new InfoStandFurniView(this,this.const_1672,this._catalog);
         this.var_125 = new InfoStandUserView(this,this.const_1675);
         this.var_331 = new InfoStandPetView(this,this.const_1673);
         this.var_398 = new InfoStandBotView(this,this.const_1674);
         this.var_1334 = new InfostandUserData();
         this.var_480 = new InfostandFurniData();
         this.var_1340 = new InfoStandPetData();
         this.var_148 = new Timer(this.const_1952);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_59,HabboWindowStyle.const_39,HabboWindowParam.const_39,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_673,this.onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_164,this.onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_158,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_63,this.onUserBadges);
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_737,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_699,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_161,this.onPetInfo);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_673,this.onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_164,this.onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_158,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_63,this.onUserBadges);
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_737,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_699,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_161,this.onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_386,this.var_331.getCurrentPetId()));
      }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_331.update(this.petData);
      ...
      {
         this.var_331.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_125.setTags(param1.tags,this.var_2326);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_286:
               ...
               {
                  _loc2_ = param1.id == this.var_1334.userRoomId;
                  break;
               }
               if(this.var_331 != null && this.var_331.window != null && this.var_331.window.visible)
               {
                  _loc2_ = param1.id == this.var_1340.roomIndex;
                  break;
               }
