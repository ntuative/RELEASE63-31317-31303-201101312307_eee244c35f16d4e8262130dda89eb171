package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_156:IFrameWindow;
      
      private var var_612:IWindow;
      
      private var var_210:IBorderWindow;
      
      private var var_1134:TagListRenderer;
      
      private var var_129:IBorderWindow;
      
      private var var_2532:int;
      
      private const const_936:int = 5;
      
      private const const_1688:int = 39;
      
      private const const_1690:int = 7829367;
      
      private const const_1689:int = 16777215;
      
      private const const_1970:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1134 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_50 == null || this.var_210 == null || this.var_65 == null)
         {
            return;
         }
         this.var_65.width = this.var_65.scrollableRegion.width;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_210.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_210.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_210.width < this.var_65.width)
         {
            this.var_210.x = this._window.width - this.var_210.width;
            this.var_65.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_210 = this._window.getListItemByName("info_border") as IBorderWindow;
         ...
         {
            this.var_50 = this.var_210.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_210.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_210.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_210.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_210.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_129.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_129.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_129.x = _loc5_.left - this.var_129.width;
         this.var_129.y = _loc5_.top + (_loc5_.height - this.var_129.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_129.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_129.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_129.x = _loc7_.left - this.var_129.width;
         this.var_129.y = _loc7_.top + (_loc7_.height - this.var_129.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_129 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_129 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_936;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1690;
            }
            else
            {
               _loc3_.textColor = this.const_1689;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_936;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_375,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_375,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1134.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_167);
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_167:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1143:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2532 > this.const_1970 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2532 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1690;
            if(_loc3_.length >= this.const_1688)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1688 - 1);
            }
         }
      }
      ...
      {
         this.var_156 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_156.center();
         this.var_156.procedure = this.badgesEventProc;
         this.var_156.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_156 && this.var_156.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_612 = null;
         var _loc2_:IItemGridWindow = this.var_156.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_156.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_156.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_612);
               }
               if(_loc3_ <= -1)
               {
                  return;
