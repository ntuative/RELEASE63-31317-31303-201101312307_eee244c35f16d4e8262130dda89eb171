package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1258:int = 3;
      ...
      {
         return param1 + param2 * const_1258;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_144,const_73,const_64,const_144,const_73,const_64];
                     _loc8_ = [const_73,const_73,const_73,const_64,const_64,const_64];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
