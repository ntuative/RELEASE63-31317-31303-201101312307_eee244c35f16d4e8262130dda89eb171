package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1332:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2672 = param4 * 0 * 2 / 360;
         this.var_1889 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1180 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1180 += this.var_2672 / const_1332;
      ...
      {
         var _loc3_:Number = this.var_1459 * Math.cos(this.var_1180 + this.var_1889);
         var _loc4_:Number = this.var_1459 * Math.sin(this.var_1180 + this.var_1889);
