package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1637:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2718:Number = NaN;
      
      protected var var_2717:int = -1;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1812 != spriteCount)
         {
            createSprites(this.var_1812);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param2 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,param2,this.var_2717);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_432 != _loc3_.getUpdateID() || param1 != var_225 || param2 != this.var_2718)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_224 != _loc3_.getUpdateID())
         {
            this.var_2717 = _loc3_.getNumber(RoomObjectVariableEnum.const_212);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_282));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1218 = _loc3_.getString(RoomObjectVariableEnum.const_396);
            if(this.var_1218 == null || this.var_1218.indexOf("http") != 0)
            {
               this.var_1218 = null;
            }
            var_224 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.var_2546 != param2 || this.var_2547 != param1)
         {
            this.var_935 = [];
            this.var_936 = [];
            this.var_740 = [];
            ...
            this.var_1812 = this._data.getLayerCount(param1) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_967.length)
         {
            return "";
         }
         var _loc3_:String = this.var_935[param2];
         var _loc4_:Boolean = this.var_936[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_967[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_741[param3] != null && !this.var_1813)
         {
      ...
      {
         if(this.var_743[param2] != null)
         {
            return this.var_743[param2];
         }
         if(this._data == null)
         {
      ...
      {
         if(this.var_744[param3] != null)
         {
            return this.var_744[param3];
         }
         if(this._data == null)
         {
