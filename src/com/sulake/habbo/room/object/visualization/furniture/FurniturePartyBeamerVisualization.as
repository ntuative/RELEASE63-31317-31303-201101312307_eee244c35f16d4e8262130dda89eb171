package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_923:int = 15;
      
      private static const const_924:int = 31;
      
      private static const const_1284:int = 2;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1126[param2];
         var _loc4_:int = this.var_1128[param2];
         var _loc5_:int = this.var_1127[param2];
         var _loc6_:Number = this.var_1125[param2];
         if(param1 == 32)
         {
            _loc7_ = const_923;
         }
         ...
         this.var_1126[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1125[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1126.push(Math.random() * _loc2_ * 1.5);
         this.var_1126.push(Math.random() * _loc2_ * 1.5);
         this.var_1128 = new Array();
         this.var_1128.push(1);
         this.var_1128.push(-1);
         this.var_1127 = new Array();
         this.var_1127.push(const_1284);
         this.var_1127.push(ANIM_SPEED_SLOW);
         this.var_1125 = new Array();
         this.var_1125.push(this.getRandomAmplitudeFactor());
         this.var_1125.push(this.getRandomAmplitudeFactor());
      }
