package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1006:Point = null;
      
      private var var_1245:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_808)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1245 = this.var_41.getValue(this.var_808);
         }
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         this.var_1006.x = _loc3_.x;
         this.var_1006.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_41.getValue(this.var_808);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1523 = RoomObjectVariableEnum.const_1163;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1523 = RoomObjectVariableEnum.const_1010;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1005 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1005 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_41.getValue(this.var_808);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2052 && param3 == this.var_2051)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1005 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1005 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1523);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1245.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1006.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1006.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_381.indexOf(_loc10_) >= 0 && this.var_809)
            {
               param1 = this.var_381.indexOf(_loc10_);
               if(this.var_536[param1] != "")
               {
                  _loc9_ = this.var_1244.getAsset(this.var_536[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_535[param1] != -1)
               {
                  param2.alpha = this.var_535[param1];
               }
               this.var_381.splice(param1,1);
               this.var_536.splice(param1,1);
               this.var_535.splice(param1,1);
      ...
      {
         this.var_809 = true;
         var _loc3_:int = this.var_381.indexOf(param1);
         if(_loc3_ < 0)
         {
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_381.push(param1);
            this.var_536.push("");
            this.var_535.push(param2);
         }
         else
         {
            this.var_535[_loc3_] = param2;
         }
      }
   }
}
