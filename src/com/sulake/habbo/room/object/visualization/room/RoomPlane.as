package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_916:IPlaneRasterizer = null;
      
      private var var_771:PlaneMaskManager = null;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_916.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_725 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_345))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_293.length * param1.scale;
            ...
            if(this.var_916 != null)
            {
               _loc3_ = this.var_916.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1760,this.var_2474,this.var_2473,this.var_2475,this.var_2476,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1792 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1227.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1227[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1132);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_152.z - originZ,this.var_109.z - originZ,this.var_83.z - originZ,this.var_110.z - originZ);
            if(this._type == const_92)
            {
               relativeDepth += 0.02;
            }
            this.var_2472 = relativeDepth;
            this._isVisible = true;
            this.var_1792 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2471);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_111 || this._type == const_92)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_111 || this._type == const_92))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_249.length == this.var_917.length)
         {
            while(_loc1_ < this.var_249.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_917[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_344.length > this.var_1380.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_918 || this.var_249.length == 0 && this.var_344.length == 0 && !this.var_345 || this.var_771 == null)
         {
            return;
         }
         ...
         if(this.var_345)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_597);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_249.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_67.width - this.var_67.width * _loc3_.leftSideLoc / this.var_294.length;
                  _loc11_ = this.var_67.height - this.var_67.height * _loc3_.rightSideLoc / this.var_293.length;
                  _loc12_ = _loc3_.type;
                  this.var_771.updateMask(this.var_67,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_917.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_344.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_67.width - this.var_67.width * _loc4_.leftSideLoc / this.var_294.length;
                  _loc11_ = this.var_67.height - this.var_67.height * _loc4_.rightSideLoc / this.var_293.length;
                  _loc13_ = this.var_67.width * _loc4_.leftSideLength / this.var_294.length;
                  _loc14_ = this.var_67.height * _loc4_.rightSideLength / this.var_293.length;
                  this.var_67.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1380.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_345 = false;
