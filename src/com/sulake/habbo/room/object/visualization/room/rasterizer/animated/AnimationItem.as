package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class AnimationItem
   {
      ...
      private var var_161:Number = 0.0;
      
      private var var_1249:Number = 0.0;
      
      private var var_1248:Number = 0.0;
      ...
      public function AnimationItem(param1:Number, param2:Number, param3:Number, param4:Number, param5:BitmapData)
      {
         ...
         if(isNaN(this.var_161))
         {
            this.var_161 = 0;
         }
         if(isNaN(this.var_1249))
         {
            this.var_1249 = 0;
         }
         if(isNaN(this.var_1248))
         {
            this.var_1248 = 0;
         }
      ...
      public function getPosition(param1:int, param2:int, param3:Number, param4:Number, param5:int) : Point
      {
         ...
         var _loc7_:Number = this.var_161;
         if(param3 > 0)
         {
            _loc6_ += this.var_1249 / param3 * param5 / 1000;
         }
         if(param4 > 0)
         {
            _loc7_ += this.var_1248 / param4 * param5 / 1000;
         }
