package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_946:int = 13421772;
      
      private static const const_948:int = 10066329;
      
      private static const const_947:int = 10066329;
      
      public static const const_1561:int = 16777215;
      
      public static const const_1500:int = 13421772;
      ...
      private var var_775:Rectangle = null;
      
      private var var_516:RoomPlaneBitmapMaskParser = null;
      
      private var var_1485:String = null;
      
      private var _floorType:String = null;
      
      private var var_1486:String = null;
      
      private var var_2676:String = null;
      
      private var var_1181:uint = 16777215;
      
      private var var_2674:int = 255;
      
      private var var_2675:int = 255;
      
      private var var_2673:int = 255;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_775 = super.boundingRectangle;
         }
         return new Rectangle(this.var_775.x,this.var_775.y,this.var_775.width,this.var_775.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1161);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1038);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_171)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_198,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_154)
            {
               ...
               {
                  _loc13_.color = const_946;
               }
               else
               {
                  _loc13_.color = const_948;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1542)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_111,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_360.length)
            {
               _loc10_ = this.var_628[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_360[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_92)
               {
                  if(this.var_1891)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2673 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2675 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2674 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1792)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1417 || _loc3_.y != this.var_2600 || _loc3_.z != this.var_2599 || param1.scale != this.var_2598))
            {
               this.var_1417 = _loc3_.x;
               this.var_2600 = _loc3_.y;
               this.var_2599 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_224 != param1.getUpdateID())
         {
            ...
            if(_loc4_ != this.var_1181)
            {
               ...
               this.var_2673 = this.var_1181 & 255;
               this.var_2675 = this.var_1181 >> 8 & 255;
               this.var_2674 = this.var_1181 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_224 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_596);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_786);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_651);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_744));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_738));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_688));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_121.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_198 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_360;
         if(this.var_360.length == 0)
         {
            _loc6_ = this.var_121;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_360.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_198)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1732;
      }
         ...
         while(_loc8_ < this.var_516.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_121.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_92)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_92 && _loc12_ == RoomPlaneBitmapMaskData.const_264)
                              {
