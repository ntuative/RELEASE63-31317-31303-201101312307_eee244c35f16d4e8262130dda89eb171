package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1287:uint = 16777215;
      
      private var var_1608:int = 255;
      
      private var var_1052:uint = 16777215;
      
      private var var_1609:int = 255;
      
      private var var_1051:int = 0;
      
      private var var_1607:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1161,param1.toString(),true);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1051)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1524;
            if(_loc2_ - this.var_1051 >= this.var_1607)
            {
               _loc3_ = this.var_1052;
               _loc4_ = this.var_1609;
               this.var_1051 = 0;
            }
            else
            {
               _loc7_ = this.var_1287 >> 16 & 255;
               _loc8_ = this.var_1287 >> 8 & 255;
               _loc9_ = this.var_1287 & 255;
               _loc10_ = this.var_1052 >> 16 & 255;
               _loc11_ = this.var_1052 >> 8 & 255;
               _loc12_ = this.var_1052 & 255;
               _loc13_ = (_loc2_ - this.var_1051) / this.var_1607;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1608 + (this.var_1609 - this.var_1608) * _loc13_;
               this._color = _loc3_;
               this.var_1524 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_732:
               param2.setString(RoomObjectVariableEnum.const_786,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_803:
               param2.setString(RoomObjectVariableEnum.const_596,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_852:
               param2.setString(RoomObjectVariableEnum.const_651,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_435:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_601:
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_993:
               param2.setNumber(RoomObjectVariableEnum.const_744,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1101:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1287 = this._color;
         this.var_1608 = this.var_1524;
         this.var_1052 = _loc3_;
         this.var_1609 = _loc4_;
         this.var_1051 = getTimer();
         this.var_1607 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_519,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1404,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1406,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1622,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_519,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_171)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_154 || _loc13_ == RoomPlaneData.const_305)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
