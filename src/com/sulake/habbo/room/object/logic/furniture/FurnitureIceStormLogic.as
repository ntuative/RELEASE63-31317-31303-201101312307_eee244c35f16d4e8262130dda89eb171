   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2567 = param1.extra;
            this.var_1161 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1161 > 0 && param1 >= this.var_1161)
         {
            this.var_1161 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1665,String(this.var_1665),this.var_2567);
