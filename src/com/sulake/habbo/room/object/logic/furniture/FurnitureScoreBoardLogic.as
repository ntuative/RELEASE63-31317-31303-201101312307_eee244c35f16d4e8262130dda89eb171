package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_884:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_656 != _loc2_)
         {
            _loc3_ = this.var_656 - _loc2_;
            if(_loc3_ < 0)
            {
               _loc3_ = -_loc3_;
            }
            if(_loc3_ * const_406 > const_884)
            {
               this.var_995 = const_884 / _loc3_;
            }
            else
            {
               this.var_995 = const_406;
            }
            this.var_1233 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_656 && param1 >= this.var_1233 + this.var_995)
            {
               _loc3_ = param1 - this.var_1233;
               ...
               if(_loc4_ > _loc5_ * (this.var_656 - _loc2_))
               {
                  _loc4_ = _loc5_ * (this.var_656 - _loc2_);
               }
               object.setState(_loc2_ + _loc5_ * _loc4_,0);
               this.var_1233 = param1 - (_loc3_ - _loc4_ * this.var_995);
            }
         }
      }
   }
