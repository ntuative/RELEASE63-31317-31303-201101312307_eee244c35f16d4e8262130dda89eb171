package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1635:String = "ctlg_";
       
      
      protected var var_1960:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1165:ICatalogViewer;
      ...
      private var var_1303:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1303 = new EventDispatcher();
         this.var_59 = new Array();
         this.init();
      }
      ...
      {
         return this._localization.getLinks(this.var_1064);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1064);
      }
      ...
      {
         var _loc2_:String = const_1635 + param1;
         ...
         this.var_1960 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1960) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         this.var_59.push(new LocalizationCatalogWidget(this._window));
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1445) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1302 = new ItemGridCatalogWidget(_loc1_);
            this.var_59.push(this.var_1302);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1632) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ItemGroupCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1460) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ProductViewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1424) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new SingleViewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1416) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new PurchaseCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1444) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new PurseCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1378) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ColourGridCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1569) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new TraxPreviewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1572) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new RedeemItemCodeCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1435) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new SpacesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1627) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new TrophyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1433) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new PetsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1426) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new BotCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1449) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new TextInputCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1442) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new SpecialInfoWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1346) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new RecyclerCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1355) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new RecyclerPrizesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1594) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new MarketPlaceCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1568) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new MarketPlaceOwnItemsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1407) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ClubGiftWidget(_loc1_,this._catalog.getClubGiftController()));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1408) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ClubBuyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1469) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_59.push(new ActivityPointDisplayCatalogWidget(_loc1_));
         }
         for each(_loc2_ in this.var_59)
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1303;
            _loc2_.init();
         }
         this.var_1303.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1303.dispatchEvent(param1);
      }
   }
}
