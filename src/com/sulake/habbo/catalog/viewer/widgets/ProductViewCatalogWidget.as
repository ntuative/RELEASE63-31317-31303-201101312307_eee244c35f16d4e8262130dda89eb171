package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1625:Point;
      
      private var var_462:IItemGridWindow;
      
      private var var_1298:IScrollbarWindow;
      ...
      {
         this.var_857 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1061 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1625 = new Point(this.var_82.x,this.var_82.y);
         this.var_462 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1298 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_857.text = _loc4_;
         this.var_1061.text = _loc5_;
         this.var_857.height = this.var_857.textHeight + 5;
         this.var_1061.y = this.var_857.y + this.var_857.height;
         this.var_1061.height = Math.max(130,this.var_1061.textHeight + 5);
         if(ProductImageConfiguration.hasProductImage(_loc2_.localizationId))
         {
            this.setPreviewFromAsset(ProductImageConfiguration.const_30[_loc2_.localizationId]);
         }
         else
         {
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_52);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_46,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_280,AvatarAction.const_462);
                              _loc16_.appendAction(AvatarAction.const_310,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2229)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2229 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            this.var_82.x = this.var_1625.x;
            this.var_82.y = this.var_1625.y;
            if(param3 != null)
            {
