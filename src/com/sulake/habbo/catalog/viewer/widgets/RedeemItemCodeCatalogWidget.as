package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_979.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_978 != null)
         {
            this.var_978.removeEventListener(WindowKeyboardEvent.const_162,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_979 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_979 != null)
         {
            this.var_979.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_978 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_978 != null)
         {
            this.var_978.addEventListener(WindowKeyboardEvent.const_162,this.windowKeyEventProcessor);
         }
      }
