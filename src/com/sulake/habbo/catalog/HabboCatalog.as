package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_313:ICatalogNavigator;
      ...
      private var var_281:ChargeConfirmationDialog;
      ...
      private var var_2186:GiftWrappingConfiguration;
      
      private var var_1047:ClubGiftController;
      
      private var var_456:ClubBuyController;
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_96.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_96.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_201 == null)
            {
               this.var_201 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_201.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_456.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_313.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_176.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_176.getKey("link.format.credits","/credits");
            this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_6);
      ...
      {
         var _loc3_:* = null;
         if(param2 == ProductTypeEnum.const_90)
         {
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_96.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_96.getActivityPointsForType(Purse.const_181)));
         var _loc1_:int = 0;
         if(!this.var_96.hasClubLeft)
         {
         ...
         else
         {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_96.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_96.clubPeriods));
         }
      ...
      {
         this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_708)
         {
            if(!this.var_395.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_313 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_247,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_88:
               this.var_1601 = param1.session.isPrivateRoom;
               if(this.var_87 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_119 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1047 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_456 == null)
         {
            this.var_456 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_313.buildCatalogIndex(_loc2_);
         if(this.var_678 && this.var_678 != "")
         {
            this.var_313.openPage(this.var_678);
            this.var_678 = "";
            this.var_844 = -1;
         }
         else if(this.var_844 > -1)
         {
            this.var_313.openPageById(this.var_844,this.var_1602);
            this.var_844 = -1;
            this.var_1602 = -1;
            this.var_678 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_96.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2188 && this.var_554 != null)
         {
            this.var_554.playSound(HabboSoundTypesEnum.const_1115);
         }
         this.var_2188 = false;
         if(this.var_281 != null)
         {
            this.var_281.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_68,this.var_96.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_96.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2187 && this.var_554 != null)
         {
            this.var_554.playSound(HabboSoundTypesEnum.const_1133);
         }
         this.var_2187 = false;
         if(this.var_281 != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_102,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_96.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_102,_loc2_.points["null"]));
         }
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_96.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_96.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_96.isVIP = _loc2_.isVIP;
         this.var_96.pastClubDays = _loc2_.pastClubDays;
         this.var_96.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1047.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_119 != null)
         {
            this.var_119.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_119 != null)
         {
            this.var_119.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_119 != null)
         {
            this.var_119.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2186 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_119.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_281 == null)
         {
            this.var_281 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_281.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_176.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_176.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_6);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_187)
         {
            _loc3_ = this.var_176.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.method_6);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function method_6(param1:IAlertDialog, param2:Event) : void
      {
         param1.dispose();
      }
