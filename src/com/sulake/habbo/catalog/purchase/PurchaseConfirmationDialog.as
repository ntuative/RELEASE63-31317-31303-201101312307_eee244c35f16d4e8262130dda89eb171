package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1969:int = 10;
      ...
      private const const_1694:uint = 4.293848814E9;
      
      private const const_1695:uint = 4.294967295E9;
      
      private const const_1968:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1707 = _loc1_.stuffTypes;
            this.var_720 = _loc1_.boxTypes;
            this.var_721 = _loc1_.ribbonTypes;
            this.var_1123 = this.var_1707[0];
            this.var_342 = this.var_720[0];
            this.var_343 = this.var_721[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_343 < 0)
         {
            this.var_343 = this.var_721.length - 1;
         }
         if(this.var_343 > this.var_721.length - 1)
         {
            this.var_343 = 0;
         }
         if(this.var_342 < 0)
         {
            this.var_342 = this.var_720.length - 1;
         }
         if(this.var_342 > this.var_720.length - 1)
         {
            this.var_342 = 0;
         }
         var _loc1_:int = this.var_720[this.var_342] * 1000 + this.var_721[this.var_343];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_88.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1123,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1376 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1707;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_90);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1123);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_720[this.var_342]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_721[this.var_343]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_88,this.var_1375,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_88.offerId,this.var_1375);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_121:
               ...
               for each(_loc7_ in this.var_221)
               {
                  ...
                  if(_loc5_.length >= this.const_1969)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2463 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_375:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_595 == null)
         {
            this.var_595 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_595.procedure = this.suggestionsEventHandler;
         }
         if(this.var_248 == null || this.var_595 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_595.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1968;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1694) : uint(this.const_1695);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1123;
               }
            }
            _loc4_++;
         }
