package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_182:int = 5;
      ...
      {
         return this.var_569 != const_911;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1654 != RecyclerStatusMessageEvent.const_1127;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_569 == const_408;
      }
      ...
      public function init(param1:IRecyclerVisualization = null) : void
      {
         ...
         this.var_107 = new Array(const_182);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_182)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_569 = const_911;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1498:
               this.var_569 = const_408;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1127:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1538:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_107.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_182)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_107.length < const_182)
         {
            return false;
         }
         var _loc1_:int = 0;
