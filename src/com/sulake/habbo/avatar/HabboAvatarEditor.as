package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1201:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1202:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1011:AvatarEditorHandler;
      ...
      private var var_818:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_181)
         {
            ...
            _loc2_.loadAvatarData(const_1201,FigureData.const_74);
            _loc3_.loadAvatarData(const_1202,FigureData.FEMALE);
            this.var_94 = new Map();
            this.var_448 = new Map();
            this.var_94.add(AvatarEditorFigureCategory.const_847,new BodyModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_46,new HeadModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_221,new TorsoModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_761,new LegsModel(this));
            ...
            this.var_448.add(AvatarEditorSideCategory.const_99,new WardrobeModel(this));
            this.var_448.add(AvatarEditorSideCategory.const_537,new ClubPromoModel(this));
            this.var_181 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_818.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_818.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this._windowContext == null)
            {
               this._windowContext = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_847);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_448.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         this.var_818 = this.var_447.getFigureData(AvatarType.const_112);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1011 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_541[this.var_958];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1251 != null)
         {
            ...
            this.var_1251.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1532;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1012 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1200)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1464.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1198.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1479)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1198.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_448.getValue(AvatarEditorSideCategory.const_99);
      }
