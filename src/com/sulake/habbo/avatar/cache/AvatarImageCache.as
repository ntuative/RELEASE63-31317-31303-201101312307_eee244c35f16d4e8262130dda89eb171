package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1683:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1447:IAvatarImage;
      ...
      private var var_346:IActiveActionData;
      ...
      private var var_2480:ByteArray;
      
      private var var_2479:ImageData;
      
      private var var_1762:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_726 == GeometryType.const_1015 && param1 == GeometryType.const_1138 || this.var_726 == GeometryType.const_1138 && param1 == GeometryType.const_1015)
         {
            this.var_726 = param1;
            this.var_81 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_346 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_346;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_346 || !this.var_346.definition))
         {
            if(this.var_346.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_346.definition.state + "." + this.var_346.actionParameter);
               _loc13_ = param2 - this.var_346.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_346.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     if(this._scale == AvatarScaleType.const_52)
                     {
                        _loc8_.x = _loc14_.dx;
                        _loc8_.y = _loc14_.dy;
                     }
                     ...
                     {
                        this.var_346 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_727)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_507)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1447.getFigure(),_loc5_,this.var_726,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_421 == null)
         {
            ...
            this.var_421 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_346);
            if(this.var_421 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_81)
         {
            this.var_81 = this._structure.getCanvas(this._scale,this.var_726);
            if(!this.var_81)
            {
               return null;
            }
            this.var_2481 = new Point(0,this.var_81.height - int(this.var_81.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1546[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_711 || _loc10_ == AvatarAction.const_382;
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!(param1 == 7 && (this.var_111.partType == "fc" || this.var_111.partType == "ey")))
            {
               ...
               this.var_1761 = this.var_111.partId;
               ...
               this.var_1382 = this._scale + "_" + this.var_111.action.assetPartDefinition + "_" + this.var_173 + "_" + this.var_1761 + "_" + _loc5_ + "_" + this._frame;
               this.var_412 = this._assets.getAssetByName(this.var_1382) as BitmapDataAsset;
               if(this.var_412 == null)
               {
                  this.var_1382 = this._scale + "_std_" + this.var_173 + "_" + this.var_1761 + "_" + _loc5_ + "_0";
                  this.var_412 = this._assets.getAssetByName(this.var_1382) as BitmapDataAsset;
               }
               if(!(!this.var_412 || !this.var_412.content))
               {
                  ...
                  {
                     this.var_1762 = this._structure.renderManager.paletteManager.getPalette(this.var_111.paletteMapId);
                     if(this.var_1762 != null)
                     {
                        this.var_921 = this.var_412.content as BitmapData;
                        this.var_174 = new BitmapData(this.var_921.width,this.var_921.height);
                        this.var_2480 = this.var_1762.colorize(this.var_921.getPixels(this.var_921.rect));
                        this.var_174.setPixels(this.var_174.rect,this.var_2480);
                     }
                     else
                     {
                        this.var_174 = (this.var_412.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1381 == AvatarBodyPartType.const_221 || this.var_1381 == AvatarBodyPartType.const_1471 || this.var_1381 == AvatarBodyPartType.const_1558) && this.var_111.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_174.colorTransform(this.var_174.rect,this.var_111.color.colorTransform);
                  }
                  if(this.var_111.isBlendable)
                  {
                     this.var_174.colorTransform(this.var_174.rect,this.var_111.blendTransform);
                  }
                  this.var_920 = this.var_412.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_52)
                     {
                  ...
                  this.var_2479 = new ImageData(this.var_174,this.var_920,_loc7_);
                  this.var_919.push(this.var_2479);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2481.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_52)
            {
