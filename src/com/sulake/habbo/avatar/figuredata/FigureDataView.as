package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         {
            this.var_421 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_421 && this.var_1129)
         {
            this.var_421.bitmap = new BitmapData(this.var_421.width,this.var_421.height,true,16777215);
            this.var_421.bitmap.copyPixels(this.var_1129,this.var_1129.rect,new Point(0,this.var_421.height - this.var_1129.height - 8));
            this.var_421.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
