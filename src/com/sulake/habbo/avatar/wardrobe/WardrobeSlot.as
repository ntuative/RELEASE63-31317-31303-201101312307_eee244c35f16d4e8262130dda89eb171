package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_627 && this.var_1443)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_84,this.var_958,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_33,parseInt(FigureData.const_646));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1443 && this.var_627 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_627 = this._controller.figureData.getFigureString();
               this.var_958 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1890,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_627)
               {
                  this._controller.loadAvatarInEditor(this.var_627,this.var_958,this._controller.clubMemberLevel);
               }
         }
      }
