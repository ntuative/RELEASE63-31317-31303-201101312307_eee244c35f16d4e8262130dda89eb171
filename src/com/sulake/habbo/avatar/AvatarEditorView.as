package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1198:IWindowContainer;
      
      public static var var_1464:IWindowContainer;
      
      public static var var_1925:int = 6710886;
      ...
      private var var_453:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1035 = [];
         this.var_1279 = [AvatarEditorFigureCategory.const_847,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_221,AvatarEditorFigureCategory.const_761,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1198 == null)
         {
            ...
            var_1198 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1464 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1464 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_383 = new Timer(1000);
         this.var_383.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1279;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_383.stop();
            this.var_383.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_383 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1279);
         }
         if(param1.length != this.var_1035.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1035.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2150 = this.canChangeOutfit();
            this.var_383.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_453 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_453.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_453.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1035.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_453.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_453.numSelectables)
               {
                  this.var_453.getSelectableAt(_loc6_).x = this.var_453.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1279;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1588 == AvatarEditorSideCategory.const_99 || this.var_2151))
         {
         ...
         this.setViewToCategory(this.var_348);
      }
      ...
      {
         if(this.var_1588 == AvatarEditorSideCategory.const_99)
         {
            this.var_2151 = false;
            this.setSideContent(AvatarEditorSideCategory.const_882);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_882:
               break;
            case AvatarEditorSideCategory.const_537:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_537);
               break;
