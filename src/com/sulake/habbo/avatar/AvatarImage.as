package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1203:String = "Default";
      
      private static const const_1205:int = 2;
      
      private static const const_1204:String = AvatarSetType.const_33;
      ...
      protected var var_266:IActiveActionData;
      
      protected var var_695:Boolean;
      ...
      protected var var_627:AvatarFigureContainer;
      
      protected var var_524:IAvatarDataContainer;
      ...
      protected var var_1215:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         if(this._scale == null)
         {
            this._scale = AvatarScaleType.const_52;
         }
         if(param3 == null)
         {
         ...
         this.setDirection(const_1204,const_1205);
         this.var_303 = new Array();
         this.var_819 = new ActiveActionData(AvatarAction.const_365);
         this.var_819.definition = this._structure.getActionDefinition(const_1203);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_695)
         {
            ...
            if(this.var_736)
            {
               for each(_loc2_ in this.var_736)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_627,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1534;
         if(param2 < AvatarDirectionAngle.const_987)
         {
            param2 = AvatarDirectionAngle.const_299 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_299)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_46 || param1 == AvatarSetType.const_33)
         {
            if(param1 == AvatarSetType.const_46 && this.isHeadTurnPreventedByAction())
            {
               param2 = this.var_85;
            }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_611,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_255.length == 1 && this.var_85 == this.var_1968)
         {
            return this.var_85 + this.var_502 + this.var_611 % 4;
         }
         if(this.var_255.length == 2)
         {
            for each(_loc1_ in this.var_255)
            {
               ...
               {
                  return this.var_85 + this.var_502 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_611 % 11;
                  return this.var_85 + "_" + this.var_1968 + this.var_502 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2529 || param2 != this.var_2530 || param1 != this.var_2531)
         {
            this.var_2529 = param3;
            this.var_2530 = param2;
            this.var_2531 = param1;
            this.var_1798 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_266.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1215 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1215)
            {
               this.var_43.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_266.definition.geometryType,this.var_85);
         this.var_43.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_611);
         ...
         {
            if(this.var_524.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_524.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_266.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_266.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_611);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_303.length)
         {
            _loc3_ = this.var_303[_loc4_];
         ...
         this.var_303.push(new ActiveActionData(param1,param2,this.var_611));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_266 = this.var_819;
         this.var_266.definition = this.var_819.definition;
         this.resetBodyPartCache(this.var_819);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_502 = "";
         this.var_255 = this._structure.sortActions(this.var_303);
         if(this.var_255 == null)
         {
         ...
         {
            this.var_765 = this._structure.getCanvasOffsets(this.var_255,this._scale,this.var_85);
            for each(_loc4_ in this.var_255)
            {
               this.var_502 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_310)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1400 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1400 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1399 != this.var_502)
            {
               _loc1_ = true;
               this.var_1399 = this.var_502;
            }
         }
         this.var_1254 = true;
         return _loc1_;
         ...
         for each(_loc1_ in this.var_255)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_194 = this.var_194.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1534 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_524 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_302 || _loc1_.actionType == AvatarAction.const_209 || _loc1_.actionType == AvatarAction.const_382)
               {
                  this.var_820 = true;
               }
            }
