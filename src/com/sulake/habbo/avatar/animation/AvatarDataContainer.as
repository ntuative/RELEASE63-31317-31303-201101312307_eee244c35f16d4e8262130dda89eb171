package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var include:Number = 1.0;
      
      private var var_1502:Number = 1.0;
      ...
      {
         super();
         this.var_1736 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2414 = parseInt(_loc2_,16);
         this.var_2413 = parseInt(_loc3_,16);
         ...
         this.var_1647 = new ColorTransform(this.include,this.var_1502,this.var_1501,this._alphaMultiplier);
         this.var_1111 = this.generatePaletteMapForGrayscale(this.var_2413,this.var_2414);
      }
      ...
      {
         return this.var_1111.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1111.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1111.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1111.getValue("alphas") as Array;
      }
