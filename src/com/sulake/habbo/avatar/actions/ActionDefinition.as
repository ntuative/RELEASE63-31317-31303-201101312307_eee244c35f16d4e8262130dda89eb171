package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2652 = parseInt(param1.@precedence);
         this.var_2649 = String(param1.@activepartset);
         this.var_2650 = String(param1.@assetpartdefinition);
         this.var_2654 = String(param1.@lay);
         this.var_726 = String(param1.@geometrytype);
         this.var_2113 = Boolean(parseInt(param1.@main));
         this.var_2651 = Boolean(parseInt(param1.@RoomSettingsCtrl));
         this.var_2655 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "RoomSettingsCtrl")
            {
               this.var_2653 = _loc6_;
            }
            else
            {
               this.var_1868[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1868[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2653;
         }
         return _loc2_;
      }
