package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_973:String = "AssetLibraryReady";
      
      public static const const_603:String = "AssetLibraryLoaded";
      
      public static const const_1511:String = "AssetLibraryUnloaded";
      
      public static const const_1496:String = "AssetLibraryLoadError";
      
      private static var var_269:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_437:uint = 0;
      
      private static var var_795:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_644 = new XML();
         this.var_373 = 0;
         this.var_371 = new Array();
         if(var_269 == null)
         {
            var_269 = new Dictionary(false);
         ...
         ++var_437;
         this.var_372 = new Dictionary(false);
         this.var_436 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_795.splice(var_795.indexOf(this),1);
            --var_437;
            this.var_436 = null;
            this.var_797 = null;
            this.var_137 = null;
      ...
      {
         if(this._file == param1.url && this.var_798)
         {
            if(!this.var_796 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_644,this.var_530);
            }
            this.var_796 = param2;
            dispatchEvent(new Event(AssetLibrary.const_973));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_798 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1511));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_797[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_436[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1088,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1111,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_953,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_958,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_436[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_436[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_373;
                     this.var_371.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_436[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_371.length ? this.getAssetByName(this.var_371[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_137)
         {
            ...
            {
               return this.var_371.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_137[param1] != null || (this.var_530 != null ? this.var_530[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_269.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_269[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_372.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_372[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_269[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_372[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_269)
            {
               _loc3_ = AssetTypeDeclaration(var_269[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_372)
         {
            _loc3_ = AssetTypeDeclaration(this.var_372[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_269)
            {
               _loc4_ = AssetTypeDeclaration(var_269[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_372)
         {
            _loc4_ = AssetTypeDeclaration(this.var_372[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_644 = _loc2_.manifest.copy();
         this.var_530 = _loc2_.resource;
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1496));
         this.var_39 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_644.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_530[param1]);
