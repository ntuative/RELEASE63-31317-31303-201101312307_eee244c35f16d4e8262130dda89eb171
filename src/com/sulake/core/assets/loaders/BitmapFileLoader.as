package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_967 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_39 = new Loader();
         this.var_971 = new LoaderContext();
         this.var_971.checkPolicyFile = true;
         ...
         {
            this.var_39.load(param2,this.var_971);
         }
      }
      ...
      {
         this.var_967 = param1.url;
         var_304 = 0;
         this.var_39.load(param1,this.var_971);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_304 < var_2724)
            {
               ...
               this.var_39.load(new URLRequest(this.var_967 + (this.var_967.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_304),this.var_971);
               return true;
            }
         }
         return false;
