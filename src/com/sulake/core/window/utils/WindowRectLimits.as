package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_295:int = 2.147483647E9;
      
      private var var_298:int = -2.147483648E9;
      ...
      {
         this.var_295 = param1;
         if(this.var_295 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_295)
         {
      ...
      {
         this.var_298 = param1;
         if(this.var_298 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_298)
         {
            this._target.height = this.var_298;
         }
      }
      ...
      {
         return this.var_296 == int.MIN_VALUE && this.var_295 == int.MAX_VALUE && this.var_298 == int.MIN_VALUE && this.var_297 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_296 = int.MIN_VALUE;
         this.var_295 = int.MAX_VALUE;
         this.var_298 = int.MIN_VALUE;
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_295)
            {
               this._target.width = this.var_295;
            }
            if(this._target.height < this.var_298)
            {
               this._target.height = this.var_298;
            }
