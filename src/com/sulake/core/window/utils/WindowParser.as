package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1884:String = "_INCLUDE";
      
      public static const const_1872:String = "_TEMP";
      
      private static const const_1290:String = "layout";
      
      private static const const_933:String = "window";
      
      private static const const_935:String = "variables";
      
      private static const const_934:String = "filters";
      
      private static const const_587:String = "name";
      
      private static const const_1299:String = "style";
      
      private static const const_588:String = "params";
      
      private static const const_1298:String = "tags";
      ...
      private static const const_1293:String = "visible";
      
      private static const const_1289:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1095:String = "blend";
      
      private static const const_1294:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1288:String = "treshold";
      ...
      private static const const_1292:String = "height_min";
      
      private static const const_1301:String = "height_max";
      
      private static const const_589:String = "true";
      
      private static const const_150:String = "0";
      
      private static const const_1295:String = "$";
      
      private static const const_1265:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1291:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1297:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1217:Dictionary;
      
      protected var var_1216:Dictionary;
      
      protected var var_972:Dictionary;
      
      protected var var_1472:Dictionary;
      
      protected var var_1969:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1216 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1217,this.var_1216);
         this.var_972 = new Dictionary();
         this.var_1472 = new Dictionary();
         ParamCodeTable.fillTables(this.var_972,this.var_1472);
         this.var_1969 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1297,const_48);
         return param1.replace(const_1291,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1216)
            {
               delete this.var_1216[_loc1_];
            }
            for(_loc1_ in this.var_972)
            {
               delete this.var_972[_loc1_];
            }
            for(_loc1_ in this.var_1472)
            {
               delete this.var_1472[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1290)
         {
            _loc8_ = param1.child(const_935);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_934).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_587,variables,"")));
         style = uint(this.parseAttribute(xml,const_1299,variables,style));
         params = uint(this.parseAttribute(xml,const_588,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1298,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_150));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_150));
         rect.width = Number(this.parseAttribute(xml,const_1266,variables,const_150));
         rect.height = Number(this.parseAttribute(xml,const_1264,variables,const_150));
         visible = this.parseAttribute(xml,const_1293,variables,visible.toString()) == const_589;
         caption = unescape(String(this.parseAttribute(xml,const_1289,variables,caption)));
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_588).length() > 0)
         {
            list = xml.child(const_588).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_587,variables,"") as String;
               if(this.var_972[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_587)) + "\"!");
               }
               params |= this.var_972[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1265);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_15.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_935)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1292,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1301,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_589;
         blend = Number(this.parseAttribute(xml,const_1095,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1294,variables,window.clipping.toString()) == const_589;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1288,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_934).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1216[param1.type];
