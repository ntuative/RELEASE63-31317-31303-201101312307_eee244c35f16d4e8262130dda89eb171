package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_508:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_595:String = "{";
      
      private static const const_594:String = "}";
      
      private static const const_1326:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_197],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_197] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_508.indexOf(_loc4_.name) == -1)
            {
               var_508.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_594);
         if(countSubStrings(param1,const_595) != countSubStrings(param1,const_594))
         {
            throw new Error("Mismatching amount of \"" + const_595 + "\" versus \"" + const_594 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1326) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1327) + 2,_loc5_.length);
            }
