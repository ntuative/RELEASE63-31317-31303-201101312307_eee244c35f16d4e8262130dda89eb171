package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1457:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1456:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_159:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_159 = this.profiler;
         this._windowManager = param2;
         this.var_836 = param3;
         var _loc4_:ByteArray = new var_1457() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_159)
         {
            this.var_159.removeStopEventListener(this.refresh);
            this.var_159 = null;
         }
         if(!this.var_159 && param1)
         {
            this.var_159 = param1;
            this.var_159.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_703)
            {
               this.var_1907 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_159.getProfilerAgentsInArray();
         ...
         if(this.var_1907)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_159.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_159.numBitmapAssetInstances + " / " + this.var_159.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_836.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_159.numTrackedBitmapDataInstances + " / " + this.var_159.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1456() as ByteArray;
