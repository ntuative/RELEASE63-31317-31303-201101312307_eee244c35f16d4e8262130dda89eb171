package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1081:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1196:String = "_COLORIZE";
      
      protected static const const_1636:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1319:Point = new Point();
      ...
      protected var var_639:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_325 = new Rectangle();
         if(_loc12_ != null)
         {
            var_369 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_58 = var_369.clone();
            var_11 = var_369.clone();
         ...
         if(_loc13_)
         {
            var_750 = _loc13_.blend;
            var_429 = _loc13_.var_2701;
            if(var_430 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_222 != _loc13_.color)
            {
      ...
      {
         return this.var_639 != null ? this.var_639 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_430 = param1;
         var_222 = !!var_430 ? uint(var_222 | var_526) : uint(var_222 & 16777215);
         this.var_160 = this.var_160 || param1;
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_222 = !!var_430 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_526 = param1 << 24;
         var_222 = !!var_430 ? uint(var_526 | var_222) : uint(16777215 & var_222);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      
      public function set blend(param1:Number) : void
      {
         var_750 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1095);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_539,this,null));
         }
      }
      ...
      {
         var_429 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_325 = this._parent.rectangle.clone();
               var_58.x = var_11.x;
               var_58.y = var_11.y;
               var_58.width = var_11.width;
               var_58.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_452,this,this._parent));
            }
            else
            {
               this.var_325.x = 0;
               this.var_325.y = 0;
               this.var_325.width = 0;
               this.var_325.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1071,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_825,var_11);
            this.var_21.visible = var_368;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_19,var_15,var_11,null,this.var_639,this.properties,var_792.concat(),_id) as WindowController;
         _loc2_.var_429 = var_429;
         _loc2_.var_160 = this.var_160;
         _loc2_._debug = this._debug;
         _loc2_.var_325 = this.var_325.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_369 = var_369.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2268 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_69);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_422)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_957,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_821,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_690))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1096;
                  if(testParamFlag(WindowParam.const_345))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_247))
                        {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_290))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_192:
                  var_15.invalidate(this,var_11.union(var_58),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_569,this,null));
                     if(testParamFlag(WindowParam.const_184,WindowParam.const_165))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_174,WindowParam.const_149))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_19);
                        var_19 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_466))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_560))
                        {
               ...
               case WindowNotifyEvent.const_450:
                  var_15.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_505);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1139,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_304,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_377:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_602,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_539:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_1031);
                  break;
               case WindowNotifyEvent.const_421:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1636) == -1)
                     {
                        _loc8_.style = var_80;
                     }
                  }
               ...
               case WindowNotifyEvent.const_490:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_505);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_569:
                  this._parent.getRegionProperties(null,this.var_325);
                  this.updateScaleRelativeToParent();
                  break;
               ...
               case WindowNotifyEvent.const_304:
                  ...
                  break;
               case WindowNotifyEvent.const_665:
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1075:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1559:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1415:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1153:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1098:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1135:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_429);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_429);
      }
         ...
         if(this.var_160 && var_429 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1319,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1319,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_165);
         var _loc2_:* = !testParamFlag(WindowParam.const_147,WindowParam.const_149);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_325.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_325.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_383)
               {
      ...
      {
         if(_state == WindowState.const_470)
         {
            return true;
         }
         _state = WindowState.const_470;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1153,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         _loc1_.type = WindowNotifyEvent.const_1041;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1117,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1132;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1085;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_377;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1194,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1176,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1080 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_398,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1080 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_665,this,param1));
         return param1;
      }
