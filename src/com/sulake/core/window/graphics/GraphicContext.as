package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1439:uint = 0;
      
      public static const const_825:uint = 1;
      
      public static const const_964:uint = 2;
      
      public static const const_749:uint = 4;
      
      public static const const_1473:uint = 8;
      
      public static const const_1349:uint = 16;
      
      public static const const_1772:uint = 64;
      
      public static const const_1825:uint = 128;
      
      public static const const_985:uint = 256;
      
      protected static var var_527:uint = 0;
      
      protected static var var_306:uint = 0;
       
      
      protected var var_195:DisplayObjectContainer;
      
      protected var var_1965:Boolean;
      
      protected var var_789:Boolean;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_195.numChildren > 0)
               {
                  this.var_195.removeChildAt(0);
               }
            }
            this.var_195 = null;
            while(numChildren > 0)
         ...
         if(this.var_789)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_306 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1965,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1965,16777215);
                  }
                  var_306 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_789)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_306 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_195 == null)
         {
            this.var_195 = new Sprite();
            this.var_195.name = this.name + " - Child Container";
            this.var_195.mouseEnabled = false;
            addChild(this.var_195);
         }
         return this.var_195;
      }
      ...
      {
         return this.var_195 != null ? int(this.var_195.numChildren) : 0;
      }
