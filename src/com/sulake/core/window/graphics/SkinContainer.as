package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_893:uint = 8;
      
      private static const const_1211:String = "skin";
      
      private static const const_1214:String = "bitmap";
      
      private static const const_1210:String = "fill";
      
      private static const const_1209:String = "text";
      
      private static const const_1213:String = "label";
      
      private static const const_1212:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "null";
      
      protected static var var_305:Array;
      ...
      private var var_2103:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1561 = new Dictionary();
         this.var_2104 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1561,this.var_2104);
         this.var_2105 = new Dictionary();
         this.var_2103 = new Dictionary();
         StateCodeTable.fillTables(this.var_2105,this.var_2103);
         this.var_382 = new Dictionary();
         this.var_382[const_1211] = BitmapSkinRenderer;
         this.var_382[const_1214] = BitmapDataRenderer;
         this.var_382[const_1210] = FillSkinRenderer;
         this.var_382[const_1209] = TextSkinRenderer;
         this.var_382[const_1213] = LabelRenderer;
         this.var_382[const_1212] = ShapeSkinRenderer;
         this.var_382[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_382[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_305 == null)
         {
            var_305 = new Array();
            var_305.push(WindowState.const_65);
            var_305.push(WindowState.const_77);
            var_305.push(WindowState.const_86);
            var_305.push(WindowState.const_50);
            var_305.push(WindowState.const_89);
            var_305.push(WindowState.const_80);
            var_305.push(WindowState.const_104);
            var_305.push(WindowState.const_94);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2701 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1561[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_827[param1] = new Array(const_893);
         }
         this.var_827[param1][param2] = param3;
         if(this.var_828[param1] == null)
         {
            this.var_828[param1] = new Array(const_893);
         }
         this.var_828[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_827[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_828[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_176)
