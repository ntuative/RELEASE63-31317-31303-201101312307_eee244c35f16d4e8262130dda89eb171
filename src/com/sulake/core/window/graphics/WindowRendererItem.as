package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_908:uint = 1;
      
      private static const const_909:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_863 = 0;
         this.var_1647 = new ColorTransform();
         this.var_966 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_909) : uint(const_579);
         var _loc6_:Boolean = this.var_167.width > 0 && this.var_167.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_863))
            {
               _loc5_ = const_908;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_908)
               {
                  ...
                  if(this.var_567)
                  {
                     ...
                     _loc7_.draw(param1,this.var_99,this.var_99.rect,this.var_863,false);
                  ...
                  {
                     this.var_966.tx = param2.x;
                     this.var_966.ty = param2.y;
                     this.var_1647.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_99,this.var_966,this.var_1647,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_835.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_176)
            {
               _loc2_ = this.var_835.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_176);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_835.getTheActualState(param1.type,param1.style,param1.state) != this.var_1313;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_505:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1031:
               this.var_863 = this.var_835.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_863 != this.var_1313)
               {
                  this.var_567 = true;
                  _loc4_ = true;
               }
