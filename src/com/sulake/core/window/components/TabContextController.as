package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_975:ITabSelectorWindow;
      
      protected var var_1973:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_975 = findChildByTag(const_1331) as ITabSelectorWindow;
            if(this.var_975 != null)
            {
               this.var_975.procedure = this.selectorEventProc;
            }
         }
         return this.var_975;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1973 = findChildByTag(const_1330) as IWindowContainer;
         }
      ...
      {
         return !!this.var_708 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_975.numSelectables;
      }
