package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_175 == null || this.var_175.disposed)
         {
            this.var_175 = context.create(name + "::submenu","",WindowType.const_521,var_80,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_922 = false;
            this.getTitleLabel().text = this.var_598 < this.var_251.length && this.var_598 > -1 ? this.var_251[this.var_598] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_520,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_388,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_598 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_598).setStateFlag(WindowState.const_50,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_515)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1007:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_829:
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1055;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1098,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1135;
         this.update(this,_loc1_);
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_251.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_791,this.var_251,PropertyStruct.const_129,true));
         }
         else
         {
