package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1211:Boolean = false;
      
      protected var var_708:Boolean = false;
      ...
      {
         this.var_1207 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_964,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_515)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_708 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_15.handleError(WindowContext.const_380,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_805,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1604);
         _loc1_.push(this.var_1211 != PropertyDefaults.const_1160 ? new PropertyStruct(PropertyDefaults.const_697,this.var_1211,PropertyStruct.const_35,true) : PropertyDefaults.const_1492);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1174 ? new PropertyStruct(PropertyDefaults.const_819,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1360);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1069 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1405);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_697:
                  this.var_1211 = _loc2_.value as Boolean;
                  if(this.var_1211)
                  {
                     var_15.getWindowServices().getFocusManagerService().registerFocusWindow(this);
                  }
                  break;
               case PropertyDefaults.const_819:
               ...
               case PropertyDefaults.const_805:
                  ...
                  break;
               case PropertyDefaults.const_1100:
