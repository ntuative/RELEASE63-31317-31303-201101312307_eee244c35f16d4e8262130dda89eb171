package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_410:IScrollbarWindow;
      
      private var var_1759:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_410)
         {
            this.var_410.removeEventListener(WindowEvent.const_273,this.scrollBarEventProc);
            this.var_410.removeEventListener(WindowEvent.const_269,this.scrollBarEventProc);
            this.var_410 = null;
         }
         if(this.var_1131)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_410)
         {
            this.var_410 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_410)
            {
               this.var_410.addEventListener(WindowEvent.const_273,this.scrollBarEventProc);
               this.var_410.addEventListener(WindowEvent.const_269,this.scrollBarEventProc);
            }
         }
         return this.var_410;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_269)
         {
            this.hideScrollBar();
         }
      }
