package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_851:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_685:String;
      
      private var var_1056:String = null;
      
      private var var_1618:StyleSheet = null;
      ...
      {
         this.var_685 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1056 == param2)
         {
            return;
         }
         param1.var_1056 = param2;
         param1.var_1618 = null;
         if(param1.var_1056 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1056);
            param1.var_1618 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_828.indexOf(param1) > -1)
         {
            this.var_685 = param1;
         }
      }
      ...
      {
         return this.var_685 == LinkTarget.const_31 ? defaultLinkTarget : this.var_685;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1618;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_685 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_879,this.var_685,PropertyStruct.const_49,true,PropertyDefaults.const_828));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1396);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_879)
            {
               this.var_685 = _loc2_.value as String;
               break;
            }
