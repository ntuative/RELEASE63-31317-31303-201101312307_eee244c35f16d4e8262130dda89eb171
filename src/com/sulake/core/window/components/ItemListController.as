package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1962:Boolean = false;
      ...
      protected var var_2766:Number = 0.0;
      
      protected var var_2765:Number = 0.0;
      
      protected var var_787:Boolean;
      
      protected var var_366:Boolean;
      
      protected var var_968:Boolean;
      
      protected var var_1964:int = 0;
      
      protected var var_1963:int = 0;
      
      protected var var_1213:Number;
      
      protected var var_1214:Number;
      
      protected var var_1212:Boolean = false;
      
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         this._spacing = PropertyDefaults.const_453;
         this.var_787 = PropertyDefaults.const_808;
         this.var_366 = PropertyDefaults.const_877;
         this.var_968 = PropertyDefaults.const_734;
         this.var_640 = 0;
         this.var_641 = 0;
         this.var_102 = 0;
         this.var_91 = 0;
         this._horizontal = param2 == WindowType.const_354;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_160 = var_430 || !testParamFlag(WindowParam.const_32);
         this._container = var_15.create("_CONTAINER","",WindowType.const_388,WindowStyle.const_823,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_311,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_436,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_968;
      }
      ...
      {
         return new Rectangle(this.var_640 * this.maxScrollH,this.var_641 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_640)
         {
            this.var_640 = param1;
            this._container.x = -this.var_640 * this.maxScrollH;
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_523,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_641)
         {
            this.var_641 = param1;
            this._container.y = -this.var_641 * this.maxScrollV;
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_523,this,null));
         }
      }
      ...
      {
         this.var_2766 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2765 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_560,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_311,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_191:
               if(this.var_1212)
               {
                  this.var_1213 = this.var_1964 - _loc3_;
                  this.var_1214 = this.var_1963 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1213 != 0 && this.var_102 != 0)
                     {
                        this.scrollH += this.var_1213 / this.var_102;
                     }
                  }
                  else if(this.var_1214 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1214 / this.var_91;
                  }
                  this.var_1964 = _loc3_;
                  this.var_1963 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_193:
               if(this.var_1212)
               {
                  if(this._horizontal)
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1213,0);
                  }
                  else
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1214);
                  }
                  this.var_1212 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_787 && !this.var_520 && this._container)
         {
            this.var_520 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_453)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_356,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1159);
         }
         if(this.var_787 != PropertyDefaults.const_808)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_663,this.var_787,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1497);
         }
         if(this.var_366 != PropertyDefaults.const_877)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_666,this.var_366,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1602);
         }
         if(this.var_968 != PropertyDefaults.const_734)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_753,this.var_968,PropertyStruct.const_35,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_356:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_666:
               ...
               case PropertyDefaults.const_663:
                  this.var_787 = _loc2_.value as Boolean;
                  break;
            }
         }
