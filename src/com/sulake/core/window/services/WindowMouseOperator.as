package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_133:DisplayObject;
      ...
      protected var var_637:Point;
      
      protected var var_1469:uint;
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         {
            this.var_133.addEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
            this.var_133.addEventListener(MouseEvent.MOUSE_UP,this.handler,false);
            this.var_133.addEventListener(Event.ENTER_FRAME,this.handler);
            this._mouse.x = this.var_133.mouseX;
            this._mouse.y = this.var_133.mouseY;
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(this._working)
         {
            ...
            {
               this.var_133.removeEventListener(MouseEvent.MOUSE_DOWN,this.handler,false);
               this.var_133.removeEventListener(MouseEvent.MOUSE_UP,this.handler,false);
               this.var_133.removeEventListener(Event.ENTER_FRAME,this.handler);
      ...
      protected function handler(param1:Event) : void
      {
         ...
         if(this._working)
         {
            if(param1.type == Event.ENTER_FRAME)
            {
               ...
               else if(this._mouse.x != this.var_133.mouseX || this._mouse.y != this.var_133.mouseY)
               {
                  this.operate(this.var_133.mouseX,this.var_133.mouseY);
                  this._mouse.x = this.var_133.mouseX;
                  this._mouse.y = this.var_133.mouseY;
               }
               return;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_637);
         this._window.offset(this.var_637.x - this._offset.x,this.var_637.y - this._offset.y);
      }
