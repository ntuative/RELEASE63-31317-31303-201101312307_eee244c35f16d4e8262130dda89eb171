package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1629:int = 4;
      ...
      {
         return this.var_379.length + this.var_267.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_267.length < const_1629 && this.var_379.length > 0)
            {
               _loc1_ = this.var_379.shift();
               this.var_267.push(_loc1_);
               _loc1_.resume();
            }
         }
      }
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_379.indexOf(loader);
            if(index > -1)
            {
               this.var_379.splice(index,1);
            }
            index = this.var_267.indexOf(loader);
            if(index > -1)
            {
               this.var_267.splice(index,1);
            }
         }
         catch(e:Error)
         {
