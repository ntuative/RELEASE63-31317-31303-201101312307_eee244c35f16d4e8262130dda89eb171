package com.sulake.core.utils.debug
{
   ...
   public class GarbageMonitor implements IDisposable
   {
      ...
      private var var_837:Dictionary;
      
      public function GarbageMonitor()
      {
         super();
         this.var_837 = new Dictionary(true);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for each(_loc1_ in this.var_837)
            {
               delete this.var_837[_loc1_];
            }
            this.var_837 = null;
            this._disposed = true;
         }
      ...
      {
         this.var_837[param1] = param2 == null ? param1.toString() : param2;
      }
