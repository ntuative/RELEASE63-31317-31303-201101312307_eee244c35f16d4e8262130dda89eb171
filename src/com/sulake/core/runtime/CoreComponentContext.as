package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1249:String = "asset-libraries";
      
      private static const const_1255:String = "library";
      
      private static const const_1252:String = "service-libraries";
      
      private static const const_1253:String = "library";
      
      private static const const_1248:String = "component-libraries";
      
      private static const const_1251:String = "library";
      
      private static const const_1254:String = "error_data";
      
      private static const const_1250:String = "error_cat";
      
      private static const const_1256:String = "error_desc";
       
      
      private var var_326:LibraryLoaderQueue;
      
      private var var_696:IEventDispatcher;
      
      private var var_478:uint;
      
      private var var_479:Function;
      
      private var var_238:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_477.push(new Array());
            this.var_575.push(0);
            _loc3_++;
         }
         this.var_1661 = getTimer();
         ...
         switch(param2 & 0)
         {
            case Core.const_1028:
               ...
               this.var_479 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_650:
               debug("Core; using complex frame update handler");
               this.var_479 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1369:
               debug("Core; using profiler frame update handler");
               this.var_479 = this.profilerFrameUpdateHandler;
               this.var_238 = new Profiler(this);
               attachComponent(this.var_238,[new IIDProfiler()]);
               var_433.addChild(new ProfilerViewer(this.var_238));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_479 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_326.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_478 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_148)
            {
               _loc2_ = this.var_477[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1254,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1250,String(param3));
         ErrorReportStorage.setParameter(const_1256,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_696 = loadingEventDelegate;
         if(this.var_326 == null)
         {
            this.var_326 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1249)[0];
            if(node != null)
            {
               list = node.child(const_1255);
         ...
         try
         {
            node = config.child(const_1252)[0];
            if(node != null)
            {
               list = node.child(const_1253);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1389);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_696)
         {
            this.var_696.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_696)
         {
            ...
            this.var_696.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_696)
                  {
                     this.var_696.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_478 - this.var_326.length,this.var_478,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_477[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_477[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_479(_loc2_,_loc2_ - this.var_1661);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(criticality < CoreComponentContext.const_148)
         {
            ...
            receivers = this.var_477[criticality];
            index = 0;
         ...
         while(criticality < CoreComponentContext.const_148)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_238.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_238)
            {
               detachComponent(this.var_238);
               this.var_238.dispose();
               this.var_238 = null;
            }
            switch(this.var_1469 & 0)
            {
               case Core.const_1028:
                  this.var_479 = this.simpleFrameUpdateHandler;
                  break;
