package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_403:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1854:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1092:uint = 4;
       
      
      protected var var_760:uint = 0;
      
      protected var var_1204:String = "";
      ...
      private var var_457:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_457 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_457.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_457.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1204 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1204);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1469 & const_1092)
         {
            if(_loc3_ == 0)
            {
               if(this.var_457.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_846 = false;
            this._events.dispatchEvent(new LockEvent(const_403,this));
         }
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_457.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_457.getStructByIndex(_loc8_);
