package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_493:ByteArray;
      
      private var var_1117:IEncryption;
      
      private var var_715:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_279 = param2;
         this.var_493 = new ByteArray();
         this.var_1118 = new MessageClassManager();
         this.var_75 = new Socket();
         this.var_340 = new Timer(const_1518,1);
      ...
      {
         this.var_279.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_715.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_494)
         {
         ...
         {
            _loc3_ = this.var_1117.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_715.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_715.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1117 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_715.getMessages(this.var_493,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               {
                  eventsForClass = this.var_279.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_279.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_493,offset);
               this.var_493 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_493.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_493.writeByte(this.var_75.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_340.stop();
         this.var_1741 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_716));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1741 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_716));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_716));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_716));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_716));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_716));
